...
{
    AC_INTMODE_BOTHEDGE_gv         = 0x00,  /* Any Edge */
...
{
    AC_INTMODE_BOTHEDGE_gc         = (AC_INTMODE_BOTHEDGE_gv << AC_INTMODE_gp),  /* Any Edge */
...
{
    AC_MUXNEG_PIN0_gv              = 0x00,  /* Negative Pin 0 */
    AC_MUXNEG_PIN1_gv              = 0x01,  /* Negative Pin 1 */
    AC_MUXNEG_VREF_gv              = 0x02,  /* Voltage Reference */
    AC_MUXNEG_DAC_gv               = 0x03   /* DAC output */
} AC_MUXNEG_values_t;

/* Negative Input MUX Selection bit group configurations*/
typedef enum AC_MUXNEG_enum
{
    AC_MUXNEG_PIN0_gc              = (AC_MUXNEG_PIN0_gv << AC_MUXNEG_gp),  /* Negative Pin 0 */
    AC_MUXNEG_PIN1_gc              = (AC_MUXNEG_PIN1_gv << AC_MUXNEG_gp),  /* Negative Pin 1 */
    AC_MUXNEG_VREF_gc              = (AC_MUXNEG_VREF_gv << AC_MUXNEG_gp),  /* Voltage Reference */
    AC_MUXNEG_DAC_gc               = (AC_MUXNEG_DAC_gv << AC_MUXNEG_gp)   /* DAC output */
} AC_MUXNEG_t;

/* Positive Input MUX Selection bit group values */
typedef enum AC_MUXPOS_VALUES_enum
{
    AC_MUXPOS_PIN0_gv              = 0x00,  /* Positive Pin 0 */
    AC_MUXPOS_PIN1_gv              = 0x01,  /* Positive Pin 1 */
    AC_MUXPOS_PIN2_gv              = 0x02,  /* Positive Pin 2 */
    AC_MUXPOS_PIN3_gv              = 0x03   /* Positive Pin 3 */
} AC_MUXPOS_values_t;

/* Positive Input MUX Selection bit group configurations*/
typedef enum AC_MUXPOS_enum
{
    AC_MUXPOS_PIN0_gc              = (AC_MUXPOS_PIN0_gv << AC_MUXPOS_gp),  /* Positive Pin 0 */
    AC_MUXPOS_PIN1_gc              = (AC_MUXPOS_PIN1_gv << AC_MUXPOS_gp),  /* Positive Pin 1 */
    AC_MUXPOS_PIN2_gc              = (AC_MUXPOS_PIN2_gv << AC_MUXPOS_gp),  /* Positive Pin 2 */
    AC_MUXPOS_PIN3_gc              = (AC_MUXPOS_PIN3_gv << AC_MUXPOS_gp)   /* Positive Pin 3 */
} AC_MUXPOS_t;
...
typedef enum ADC_MUXPOS_VALUES_enum
{
    ...
    ADC_MUXPOS_PTC_gv              = 0x1B,  /* PTC/DAC2 */
    ADC_MUXPOS_DAC0_gv             = 0x1C,  /* DAC0/DAC0 */
    ADC_MUXPOS_INTREF_gv           = 0x1D,  /* Internal Ref */
    ADC_MUXPOS_TEMPSENSE_gv        = 0x1E,  /* Temp sensor/DAC1 */
    ADC_MUXPOS_GND_gv              = 0x1F   /* GND */
} ADC_MUXPOS_values_t;
...
typedef enum ADC_MUXPOS_enum
{
    ...
    ADC_MUXPOS_PTC_gc              = (ADC_MUXPOS_PTC_gv << ADC_MUXPOS_gp),  /* PTC/DAC2 */
    ADC_MUXPOS_DAC0_gc             = (ADC_MUXPOS_DAC0_gv << ADC_MUXPOS_gp),  /* DAC0/DAC0 */
    ADC_MUXPOS_INTREF_gc           = (ADC_MUXPOS_INTREF_gv << ADC_MUXPOS_gp),  /* Internal Ref */
    ADC_MUXPOS_TEMPSENSE_gc        = (ADC_MUXPOS_TEMPSENSE_gv << ADC_MUXPOS_gp),  /* Temp sensor/DAC1 */
    ADC_MUXPOS_GND_gc              = (ADC_MUXPOS_GND_gv << ADC_MUXPOS_gp)   /* GND */
} ADC_MUXPOS_t;
...
{
    BOD_LVL_BODLEVEL0_gv           = 0x00,  /* 1.8 V */
    BOD_LVL_BODLEVEL2_gv           = 0x02,  /* 2.6 V */
    BOD_LVL_BODLEVEL7_gv           = 0x07   /* 4.2 V */
} BOD_LVL_values_t;

/* Bod level select bit group configurations*/
typedef enum BOD_LVL_enum
{
    BOD_LVL_BODLEVEL0_gc           = (BOD_LVL_BODLEVEL0_gv << BOD_LVL_gp),  /* 1.8 V */
    BOD_LVL_BODLEVEL2_gc           = (BOD_LVL_BODLEVEL2_gv << BOD_LVL_gp),  /* 2.6 V */
    BOD_LVL_BODLEVEL7_gc           = (BOD_LVL_BODLEVEL7_gv << BOD_LVL_gp)   /* 4.2 V */
} BOD_LVL_t;

/* Sample frequency select bit group values */
typedef enum BOD_SAMPFREQ_VALUES_enum
{
    BOD_SAMPFREQ_1KHZ_gv           = 0x00,  /* 1kHz sampling frequency */
    BOD_SAMPFREQ_125HZ_gv          = 0x01   /* 125Hz sampling frequency */
} BOD_SAMPFREQ_values_t;

/* Sample frequency select bit group configurations*/
typedef enum BOD_SAMPFREQ_enum
{
    BOD_SAMPFREQ_1KHZ_gc           = (BOD_SAMPFREQ_1KHZ_gv << BOD_SAMPFREQ_bp),  /* 1kHz sampling frequency */
    BOD_SAMPFREQ_125HZ_gc          = (BOD_SAMPFREQ_125HZ_gv << BOD_SAMPFREQ_bp)   /* 125Hz sampling frequency */
} BOD_SAMPFREQ_t;
...
{
    BOD_VLMCFG_BELOW_gv            = 0x00,  /* Interrupt when supply goes below VLM level */
    BOD_VLMCFG_ABOVE_gv            = 0x01,  /* Interrupt when supply goes above VLM level */
    BOD_VLMCFG_CROSS_gv            = 0x02   /* Interrupt when supply crosses VLM level */
} BOD_VLMCFG_values_t;

/* Configuration select bit group configurations*/
typedef enum BOD_VLMCFG_enum
{
    BOD_VLMCFG_BELOW_gc            = (BOD_VLMCFG_BELOW_gv << BOD_VLMCFG_gp),  /* Interrupt when supply goes below VLM level */
    BOD_VLMCFG_ABOVE_gc            = (BOD_VLMCFG_ABOVE_gv << BOD_VLMCFG_gp),  /* Interrupt when supply goes above VLM level */
    BOD_VLMCFG_CROSS_gc            = (BOD_VLMCFG_CROSS_gv << BOD_VLMCFG_gp)   /* Interrupt when supply crosses VLM level */
} BOD_VLMCFG_t;

/* voltage level monitor level select bit group values */
typedef enum BOD_VLMLVL_VALUES_enum
{
    BOD_VLMLVL_5ABOVE_gv           = 0x00,  /* VLM threshold 5% above BOD level */
    BOD_VLMLVL_15ABOVE_gv          = 0x01,  /* VLM threshold 15% above BOD level */
    BOD_VLMLVL_25ABOVE_gv          = 0x02   /* VLM threshold 25% above BOD level */
} BOD_VLMLVL_values_t;
...
{
    CCL_CLKSRC_CLKPER_gv           = 0x00,  /* CLK_PER is clocking the LUT */
    CCL_CLKSRC_IN2_gv              = 0x01   /* IN[2] is clocking the LUT */
} CCL_CLKSRC_values_t;

/* Clock Source Selection bit group configurations*/
typedef enum CCL_CLKSRC_enum
{
    CCL_CLKSRC_CLKPER_gc           = (CCL_CLKSRC_CLKPER_gv << CCL_CLKSRC_bp),  /* CLK_PER is clocking the LUT */
    CCL_CLKSRC_IN2_gc              = (CCL_CLKSRC_IN2_gv << CCL_CLKSRC_bp)   /* IN[2] is clocking the LUT */
} CCL_CLKSRC_t;
...
typedef enum CCL_INSEL0_VALUES_enum
{
    ...
    CCL_INSEL0_EVENT0_gv           = 0x03,  /* Event input source 0 */
    CCL_INSEL0_EVENT1_gv           = 0x04,  /* Event input source 1 */
    CCL_INSEL0_IO_gv               = 0x05,  /* IO pin LUTn-IN0 input source */
    CCL_INSEL0_AC0_gv              = 0x06,  /* AC0 OUT input source */
    CCL_INSEL0_TCB0_gv             = 0x07,  /* TCB0 WO input source */
    CCL_INSEL0_TCA0_gv             = 0x08,  /* TCA0 WO0 input source */
    CCL_INSEL0_TCD0_gv             = 0x09,  /* TCD0 WOA input source */
    CCL_INSEL0_USART0_gv           = 0x0A,  /* USART0 XCK input source */
    CCL_INSEL0_SPI0_gv             = 0x0B,  /* SPI0 SCK source */
    CCL_INSEL0_AC1_gv              = 0x0C,  /* AC1 OUT input source */
    CCL_INSEL0_TCB1_gv             = 0x0D,  /* TCB1 WO input source */
    CCL_INSEL0_AC2_gv              = 0x0E   /* AC2 OUT input source */
} CCL_INSEL0_values_t;
...
typedef enum CCL_INSEL0_enum
{
    ...
    CCL_INSEL0_EVENT0_gc           = (CCL_INSEL0_EVENT0_gv << CCL_INSEL0_gp),  /* Event input source 0 */
    CCL_INSEL0_EVENT1_gc           = (CCL_INSEL0_EVENT1_gv << CCL_INSEL0_gp),  /* Event input source 1 */
    CCL_INSEL0_IO_gc               = (CCL_INSEL0_IO_gv << CCL_INSEL0_gp),  /* IO pin LUTn-IN0 input source */
    ...
    CCL_INSEL0_USART0_gc           = (CCL_INSEL0_USART0_gv << CCL_INSEL0_gp),  /* USART0 XCK input source */
    CCL_INSEL0_SPI0_gc             = (CCL_INSEL0_SPI0_gv << CCL_INSEL0_gp),  /* SPI0 SCK source */
    CCL_INSEL0_AC1_gc              = (CCL_INSEL0_AC1_gv << CCL_INSEL0_gp),  /* AC1 OUT input source */
    CCL_INSEL0_TCB1_gc             = (CCL_INSEL0_TCB1_gv << CCL_INSEL0_gp),  /* TCB1 WO input source */
    CCL_INSEL0_AC2_gc              = (CCL_INSEL0_AC2_gv << CCL_INSEL0_gp)   /* AC2 OUT input source */
} CCL_INSEL0_t;
...
typedef enum CCL_INSEL1_VALUES_enum
{
    ...
    CCL_INSEL1_EVENT0_gv           = 0x03,  /* Event input source 0 */
    CCL_INSEL1_EVENT1_gv           = 0x04,  /* Event input source 1 */
    CCL_INSEL1_IO_gv               = 0x05,  /* IO pin LUTn-N1 input source */
    CCL_INSEL1_AC0_gv              = 0x06,  /* AC0 OUT input source */
    CCL_INSEL1_TCB0_gv             = 0x07,  /* TCB0 WO input source */
    CCL_INSEL1_TCA0_gv             = 0x08,  /* TCA0 WO1 input source */
    CCL_INSEL1_TCD0_gv             = 0x09,  /* TCD0 WOB input source */
    CCL_INSEL1_USART0_gv           = 0x0A,  /* USART0 TXD input source */
    CCL_INSEL1_SPI0_gv             = 0x0B,  /* SPI0 MOSI input source */
    CCL_INSEL1_AC1_gv              = 0x0C,  /* AC1 OUT input source */
    CCL_INSEL1_TCB1_gv             = 0x0D,  /* TCB1 WO input source */
    CCL_INSEL1_AC2_gv              = 0x0E   /* AC2 OUT input source */
} CCL_INSEL1_values_t;
...
typedef enum CCL_INSEL1_enum
{
    ...
    CCL_INSEL1_EVENT0_gc           = (CCL_INSEL1_EVENT0_gv << CCL_INSEL1_gp),  /* Event input source 0 */
    CCL_INSEL1_EVENT1_gc           = (CCL_INSEL1_EVENT1_gv << CCL_INSEL1_gp),  /* Event input source 1 */
    CCL_INSEL1_IO_gc               = (CCL_INSEL1_IO_gv << CCL_INSEL1_gp),  /* IO pin LUTn-N1 input source */
    ...
    CCL_INSEL1_AC2_gc              = (CCL_INSEL1_AC2_gv << CCL_INSEL1_gp)   /* AC2 OUT input source */
} CCL_INSEL1_t;
...
typedef enum CCL_INSEL2_VALUES_enum
{
    ...
    CCL_INSEL2_EVENT0_gv           = 0x03,  /* Event input source 0 */
    CCL_INSEL2_EVENT1_gv           = 0x04,  /* Event input source 1 */
    CCL_INSEL2_IO_gv               = 0x05,  /* IO pin LUTn-IN2 input source */
    CCL_INSEL2_AC0_gv              = 0x06,  /* AC0 OUT input source */
    CCL_INSEL2_TCB0_gv             = 0x07,  /* TCB0 WO input source */
    CCL_INSEL2_TCA0_gv             = 0x08,  /* TCA0 WO2 input source */
    CCL_INSEL2_TCD0_gv             = 0x09,  /* TCD0 WOA input source */
    CCL_INSEL2_SPI0_gv             = 0x0B,  /* SPI0 MISO source */
    CCL_INSEL2_AC1_gv              = 0x0C,  /* AC1 OUT input source */
    CCL_INSEL2_TCB1_gv             = 0x0D,  /* TCB1 WO input source */
    CCL_INSEL2_AC2_gv              = 0x0E   /* AC2 OUT input source */
} CCL_INSEL2_values_t;
...
typedef enum CCL_INSEL2_enum
{
    ...
    CCL_INSEL2_EVENT0_gc           = (CCL_INSEL2_EVENT0_gv << CCL_INSEL2_gp),  /* Event input source 0 */
    CCL_INSEL2_EVENT1_gc           = (CCL_INSEL2_EVENT1_gv << CCL_INSEL2_gp),  /* Event input source 1 */
    CCL_INSEL2_IO_gc               = (CCL_INSEL2_IO_gv << CCL_INSEL2_gp),  /* IO pin LUTn-IN2 input source */
    ...
    CCL_INSEL2_TCD0_gc             = (CCL_INSEL2_TCD0_gv << CCL_INSEL2_gp),  /* TCD0 WOA input source */
    CCL_INSEL2_SPI0_gc             = (CCL_INSEL2_SPI0_gv << CCL_INSEL2_gp),  /* SPI0 MISO source */
    CCL_INSEL2_AC1_gc              = (CCL_INSEL2_AC1_gv << CCL_INSEL2_gp),  /* AC1 OUT input source */
...
{
    CLKCTRL_CLKSEL_OSC20M_gv       = 0x00,  /* 20MHz internal oscillator */
    CLKCTRL_CLKSEL_OSCULP32K_gv    = 0x01,  /* 32KHz internal Ultra Low Power oscillator */
...
{
    CLKCTRL_CLKSEL_OSC20M_gc       = (CLKCTRL_CLKSEL_OSC20M_gv << CLKCTRL_CLKSEL_gp),  /* 20MHz internal oscillator */
    CLKCTRL_CLKSEL_OSCULP32K_gc    = (CLKCTRL_CLKSEL_OSCULP32K_gv << CLKCTRL_CLKSEL_gp),  /* 32KHz internal Ultra Low Power oscillator */
...
/* CRC Flash Access Mode select bit group values */
typedef enum CRCSCAN_MODE_VALUES_enum
{
    CRCSCAN_MODE_PRIORITY_gv       = 0x00   /* Priority to flash */
} CRCSCAN_MODE_values_t;

/* CRC Flash Access Mode select bit group configurations*/
typedef enum CRCSCAN_MODE_enum
{
    CRCSCAN_MODE_PRIORITY_gc       = (CRCSCAN_MODE_PRIORITY_gv << CRCSCAN_MODE_gp)   /* Priority to flash */
} CRCSCAN_MODE_t;
...
typedef enum CRCSCAN_SRC_VALUES_enum
{
    ...
    CRCSCAN_SRC_APPLICATION_gv     = 0x01,  /* CRC on boot and appl section of flash */
...
typedef enum CRCSCAN_SRC_enum
{
    ...
    CRCSCAN_SRC_APPLICATION_gc     = (CRCSCAN_SRC_APPLICATION_gv << CRCSCAN_SRC_gp),  /* CRC on boot and appl section of flash */
...
/* Asynchronous Channel 0 Generator Selection bit group values */
typedef enum EVSYS_ASYNCCH0_VALUES_enum
{
    EVSYS_ASYNCCH0_OFF_gv          = 0x00,  /* Off */
    EVSYS_ASYNCCH0_CCL_LUT0_gv     = 0x01,  /* Configurable Custom Logic LUT0 */
    EVSYS_ASYNCCH0_CCL_LUT1_gv     = 0x02,  /* Configurable Custom Logic LUT1 */
    EVSYS_ASYNCCH0_AC0_OUT_gv      = 0x03,  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH0_TCD0_CMPBCLR_gv = 0x04,  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH0_TCD0_CMPASET_gv = 0x05,  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH0_TCD0_CMPBSET_gv = 0x06,  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH0_TCD0_PROGEV_gv  = 0x07,  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH0_RTC_OVF_gv      = 0x08,  /* Real Time Counter overflow */
    EVSYS_ASYNCCH0_RTC_CMP_gv      = 0x09,  /* Real Time Counter compare */
    EVSYS_ASYNCCH0_PORTA_PIN0_gv   = 0x0A,  /* Asynchronous Event from Pin PA0 */
    EVSYS_ASYNCCH0_PORTA_PIN1_gv   = 0x0B,  /* Asynchronous Event from Pin PA1 */
    EVSYS_ASYNCCH0_PORTA_PIN2_gv   = 0x0C,  /* Asynchronous Event from Pin PA2 */
    EVSYS_ASYNCCH0_PORTA_PIN3_gv   = 0x0D,  /* Asynchronous Event from Pin PA3 */
    EVSYS_ASYNCCH0_PORTA_PIN4_gv   = 0x0E,  /* Asynchronous Event from Pin PA4 */
    EVSYS_ASYNCCH0_PORTA_PIN5_gv   = 0x0F,  /* Asynchronous Event from Pin PA5 */
    EVSYS_ASYNCCH0_PORTA_PIN6_gv   = 0x10,  /* Asynchronous Event from Pin PA6 */
    EVSYS_ASYNCCH0_PORTA_PIN7_gv   = 0x11,  /* Asynchronous Event from Pin PA7 */
    EVSYS_ASYNCCH0_UPDI_gv         = 0x12,  /* Unified Program and debug interface */
    EVSYS_ASYNCCH0_AC1_OUT_gv      = 0x13,  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH0_AC2_OUT_gv      = 0x14   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH0_values_t;

/* Asynchronous Channel 0 Generator Selection bit group configurations*/
typedef enum EVSYS_ASYNCCH0_enum
{
    EVSYS_ASYNCCH0_OFF_gc          = (EVSYS_ASYNCCH0_OFF_gv << EVSYS_ASYNCCH0_gp),  /* Off */
    EVSYS_ASYNCCH0_CCL_LUT0_gc     = (EVSYS_ASYNCCH0_CCL_LUT0_gv << EVSYS_ASYNCCH0_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_ASYNCCH0_CCL_LUT1_gc     = (EVSYS_ASYNCCH0_CCL_LUT1_gv << EVSYS_ASYNCCH0_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_ASYNCCH0_AC0_OUT_gc      = (EVSYS_ASYNCCH0_AC0_OUT_gv << EVSYS_ASYNCCH0_gp),  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH0_TCD0_CMPBCLR_gc = (EVSYS_ASYNCCH0_TCD0_CMPBCLR_gv << EVSYS_ASYNCCH0_gp),  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH0_TCD0_CMPASET_gc = (EVSYS_ASYNCCH0_TCD0_CMPASET_gv << EVSYS_ASYNCCH0_gp),  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH0_TCD0_CMPBSET_gc = (EVSYS_ASYNCCH0_TCD0_CMPBSET_gv << EVSYS_ASYNCCH0_gp),  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH0_TCD0_PROGEV_gc  = (EVSYS_ASYNCCH0_TCD0_PROGEV_gv << EVSYS_ASYNCCH0_gp),  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH0_RTC_OVF_gc      = (EVSYS_ASYNCCH0_RTC_OVF_gv << EVSYS_ASYNCCH0_gp),  /* Real Time Counter overflow */
    EVSYS_ASYNCCH0_RTC_CMP_gc      = (EVSYS_ASYNCCH0_RTC_CMP_gv << EVSYS_ASYNCCH0_gp),  /* Real Time Counter compare */
    EVSYS_ASYNCCH0_PORTA_PIN0_gc   = (EVSYS_ASYNCCH0_PORTA_PIN0_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA0 */
    EVSYS_ASYNCCH0_PORTA_PIN1_gc   = (EVSYS_ASYNCCH0_PORTA_PIN1_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA1 */
    EVSYS_ASYNCCH0_PORTA_PIN2_gc   = (EVSYS_ASYNCCH0_PORTA_PIN2_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA2 */
    EVSYS_ASYNCCH0_PORTA_PIN3_gc   = (EVSYS_ASYNCCH0_PORTA_PIN3_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA3 */
    EVSYS_ASYNCCH0_PORTA_PIN4_gc   = (EVSYS_ASYNCCH0_PORTA_PIN4_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA4 */
    EVSYS_ASYNCCH0_PORTA_PIN5_gc   = (EVSYS_ASYNCCH0_PORTA_PIN5_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA5 */
    EVSYS_ASYNCCH0_PORTA_PIN6_gc   = (EVSYS_ASYNCCH0_PORTA_PIN6_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA6 */
    EVSYS_ASYNCCH0_PORTA_PIN7_gc   = (EVSYS_ASYNCCH0_PORTA_PIN7_gv << EVSYS_ASYNCCH0_gp),  /* Asynchronous Event from Pin PA7 */
    EVSYS_ASYNCCH0_UPDI_gc         = (EVSYS_ASYNCCH0_UPDI_gv << EVSYS_ASYNCCH0_gp),  /* Unified Program and debug interface */
    EVSYS_ASYNCCH0_AC1_OUT_gc      = (EVSYS_ASYNCCH0_AC1_OUT_gv << EVSYS_ASYNCCH0_gp),  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH0_AC2_OUT_gc      = (EVSYS_ASYNCCH0_AC2_OUT_gv << EVSYS_ASYNCCH0_gp)   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH0_t;

/* Asynchronous Channel 1 Generator Selection bit group values */
typedef enum EVSYS_ASYNCCH1_VALUES_enum
{
    EVSYS_ASYNCCH1_OFF_gv          = 0x00,  /* Off */
    EVSYS_ASYNCCH1_CCL_LUT0_gv     = 0x01,  /* Configurable custom logic LUT0 */
    EVSYS_ASYNCCH1_CCL_LUT1_gv     = 0x02,  /* Configurable custom logic LUT1 */
    EVSYS_ASYNCCH1_AC0_OUT_gv      = 0x03,  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH1_TCD0_CMPBCLR_gv = 0x04,  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH1_TCD0_CMPASET_gv = 0x05,  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH1_TCD0_CMPBSET_gv = 0x06,  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH1_TCD0_PROGEV_gv  = 0x07,  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH1_RTC_OVF_gv      = 0x08,  /* Real Time Counter overflow */
    EVSYS_ASYNCCH1_RTC_CMP_gv      = 0x09,  /* Real Time Counter compare */
    EVSYS_ASYNCCH1_PORTB_PIN0_gv   = 0x0A,  /* Asynchronous Event from Pin PB0 */
    EVSYS_ASYNCCH1_PORTB_PIN1_gv   = 0x0B,  /* Asynchronous Event from Pin PB1 */
    EVSYS_ASYNCCH1_PORTB_PIN2_gv   = 0x0C,  /* Asynchronous Event from Pin PB2 */
    EVSYS_ASYNCCH1_PORTB_PIN3_gv   = 0x0D,  /* Asynchronous Event from Pin PB3 */
    EVSYS_ASYNCCH1_PORTB_PIN4_gv   = 0x0E,  /* Asynchronous Event from Pin PB4 */
    EVSYS_ASYNCCH1_PORTB_PIN5_gv   = 0x0F,  /* Asynchronous Event from Pin PB5 */
    EVSYS_ASYNCCH1_PORTB_PIN6_gv   = 0x10,  /* Asynchronous Event from Pin PB6 */
    EVSYS_ASYNCCH1_PORTB_PIN7_gv   = 0x11,  /* Asynchronous Event from Pin PB7 */
    EVSYS_ASYNCCH1_AC1_OUT_gv      = 0x12,  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH1_AC2_OUT_gv      = 0x13   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH1_values_t;

/* Asynchronous Channel 1 Generator Selection bit group configurations*/
typedef enum EVSYS_ASYNCCH1_enum
{
    EVSYS_ASYNCCH1_OFF_gc          = (EVSYS_ASYNCCH1_OFF_gv << EVSYS_ASYNCCH1_gp),  /* Off */
    EVSYS_ASYNCCH1_CCL_LUT0_gc     = (EVSYS_ASYNCCH1_CCL_LUT0_gv << EVSYS_ASYNCCH1_gp),  /* Configurable custom logic LUT0 */
    EVSYS_ASYNCCH1_CCL_LUT1_gc     = (EVSYS_ASYNCCH1_CCL_LUT1_gv << EVSYS_ASYNCCH1_gp),  /* Configurable custom logic LUT1 */
    EVSYS_ASYNCCH1_AC0_OUT_gc      = (EVSYS_ASYNCCH1_AC0_OUT_gv << EVSYS_ASYNCCH1_gp),  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH1_TCD0_CMPBCLR_gc = (EVSYS_ASYNCCH1_TCD0_CMPBCLR_gv << EVSYS_ASYNCCH1_gp),  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH1_TCD0_CMPASET_gc = (EVSYS_ASYNCCH1_TCD0_CMPASET_gv << EVSYS_ASYNCCH1_gp),  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH1_TCD0_CMPBSET_gc = (EVSYS_ASYNCCH1_TCD0_CMPBSET_gv << EVSYS_ASYNCCH1_gp),  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH1_TCD0_PROGEV_gc  = (EVSYS_ASYNCCH1_TCD0_PROGEV_gv << EVSYS_ASYNCCH1_gp),  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH1_RTC_OVF_gc      = (EVSYS_ASYNCCH1_RTC_OVF_gv << EVSYS_ASYNCCH1_gp),  /* Real Time Counter overflow */
    EVSYS_ASYNCCH1_RTC_CMP_gc      = (EVSYS_ASYNCCH1_RTC_CMP_gv << EVSYS_ASYNCCH1_gp),  /* Real Time Counter compare */
    EVSYS_ASYNCCH1_PORTB_PIN0_gc   = (EVSYS_ASYNCCH1_PORTB_PIN0_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB0 */
    EVSYS_ASYNCCH1_PORTB_PIN1_gc   = (EVSYS_ASYNCCH1_PORTB_PIN1_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB1 */
    EVSYS_ASYNCCH1_PORTB_PIN2_gc   = (EVSYS_ASYNCCH1_PORTB_PIN2_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB2 */
    EVSYS_ASYNCCH1_PORTB_PIN3_gc   = (EVSYS_ASYNCCH1_PORTB_PIN3_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB3 */
    EVSYS_ASYNCCH1_PORTB_PIN4_gc   = (EVSYS_ASYNCCH1_PORTB_PIN4_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB4 */
    EVSYS_ASYNCCH1_PORTB_PIN5_gc   = (EVSYS_ASYNCCH1_PORTB_PIN5_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB5 */
    EVSYS_ASYNCCH1_PORTB_PIN6_gc   = (EVSYS_ASYNCCH1_PORTB_PIN6_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB6 */
    EVSYS_ASYNCCH1_PORTB_PIN7_gc   = (EVSYS_ASYNCCH1_PORTB_PIN7_gv << EVSYS_ASYNCCH1_gp),  /* Asynchronous Event from Pin PB7 */
    EVSYS_ASYNCCH1_AC1_OUT_gc      = (EVSYS_ASYNCCH1_AC1_OUT_gv << EVSYS_ASYNCCH1_gp),  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH1_AC2_OUT_gc      = (EVSYS_ASYNCCH1_AC2_OUT_gv << EVSYS_ASYNCCH1_gp)   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH1_t;

/* Asynchronous Channel 2 Generator Selection bit group values */
typedef enum EVSYS_ASYNCCH2_VALUES_enum
{
    EVSYS_ASYNCCH2_OFF_gv          = 0x00,  /* Off */
    EVSYS_ASYNCCH2_CCL_LUT0_gv     = 0x01,  /* Configurable Custom Logic LUT0 */
    EVSYS_ASYNCCH2_CCL_LUT1_gv     = 0x02,  /* Configurable Custom Logic LUT1 */
    EVSYS_ASYNCCH2_AC0_OUT_gv      = 0x03,  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH2_TCD0_CMPBCLR_gv = 0x04,  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH2_TCD0_CMPASET_gv = 0x05,  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH2_TCD0_CMPBSET_gv = 0x06,  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH2_TCD0_PROGEV_gv  = 0x07,  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH2_RTC_OVF_gv      = 0x08,  /* Real Time Counter overflow */
    EVSYS_ASYNCCH2_RTC_CMP_gv      = 0x09,  /* Real Time Counter compare */
    EVSYS_ASYNCCH2_PORTC_PIN0_gv   = 0x0A,  /* Asynchronous Event from Pin PC0 */
    EVSYS_ASYNCCH2_PORTC_PIN1_gv   = 0x0B,  /* Asynchronous Event from Pin PC1 */
    EVSYS_ASYNCCH2_PORTC_PIN2_gv   = 0x0C,  /* Asynchronous Event from Pin PC2 */
    EVSYS_ASYNCCH2_PORTC_PIN3_gv   = 0x0D,  /* Asynchronous Event from Pin PC3 */
    EVSYS_ASYNCCH2_PORTC_PIN4_gv   = 0x0E,  /* Asynchronous Event from Pin PC4 */
    EVSYS_ASYNCCH2_PORTC_PIN5_gv   = 0x0F,  /* Asynchronous Event from Pin PC5 */
    EVSYS_ASYNCCH2_AC1_OUT_gv      = 0x10,  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH2_AC2_OUT_gv      = 0x11   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH2_values_t;

/* Asynchronous Channel 2 Generator Selection bit group configurations*/
typedef enum EVSYS_ASYNCCH2_enum
{
    EVSYS_ASYNCCH2_OFF_gc          = (EVSYS_ASYNCCH2_OFF_gv << EVSYS_ASYNCCH2_gp),  /* Off */
    EVSYS_ASYNCCH2_CCL_LUT0_gc     = (EVSYS_ASYNCCH2_CCL_LUT0_gv << EVSYS_ASYNCCH2_gp),  /* Configurable Custom Logic LUT0 */
    EVSYS_ASYNCCH2_CCL_LUT1_gc     = (EVSYS_ASYNCCH2_CCL_LUT1_gv << EVSYS_ASYNCCH2_gp),  /* Configurable Custom Logic LUT1 */
    EVSYS_ASYNCCH2_AC0_OUT_gc      = (EVSYS_ASYNCCH2_AC0_OUT_gv << EVSYS_ASYNCCH2_gp),  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH2_TCD0_CMPBCLR_gc = (EVSYS_ASYNCCH2_TCD0_CMPBCLR_gv << EVSYS_ASYNCCH2_gp),  /* Timer/Counter D0 compare B clear */
    EVSYS_ASYNCCH2_TCD0_CMPASET_gc = (EVSYS_ASYNCCH2_TCD0_CMPASET_gv << EVSYS_ASYNCCH2_gp),  /* Timer/Counter D0 compare A set */
    EVSYS_ASYNCCH2_TCD0_CMPBSET_gc = (EVSYS_ASYNCCH2_TCD0_CMPBSET_gv << EVSYS_ASYNCCH2_gp),  /* Timer/Counter D0 compare B set */
    EVSYS_ASYNCCH2_TCD0_PROGEV_gc  = (EVSYS_ASYNCCH2_TCD0_PROGEV_gv << EVSYS_ASYNCCH2_gp),  /* Timer/Counter D0 program event */
    EVSYS_ASYNCCH2_RTC_OVF_gc      = (EVSYS_ASYNCCH2_RTC_OVF_gv << EVSYS_ASYNCCH2_gp),  /* Real Time Counter overflow */
    EVSYS_ASYNCCH2_RTC_CMP_gc      = (EVSYS_ASYNCCH2_RTC_CMP_gv << EVSYS_ASYNCCH2_gp),  /* Real Time Counter compare */
    EVSYS_ASYNCCH2_PORTC_PIN0_gc   = (EVSYS_ASYNCCH2_PORTC_PIN0_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC0 */
    EVSYS_ASYNCCH2_PORTC_PIN1_gc   = (EVSYS_ASYNCCH2_PORTC_PIN1_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC1 */
    EVSYS_ASYNCCH2_PORTC_PIN2_gc   = (EVSYS_ASYNCCH2_PORTC_PIN2_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC2 */
    EVSYS_ASYNCCH2_PORTC_PIN3_gc   = (EVSYS_ASYNCCH2_PORTC_PIN3_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC3 */
    EVSYS_ASYNCCH2_PORTC_PIN4_gc   = (EVSYS_ASYNCCH2_PORTC_PIN4_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC4 */
    EVSYS_ASYNCCH2_PORTC_PIN5_gc   = (EVSYS_ASYNCCH2_PORTC_PIN5_gv << EVSYS_ASYNCCH2_gp),  /* Asynchronous Event from Pin PC5 */
    EVSYS_ASYNCCH2_AC1_OUT_gc      = (EVSYS_ASYNCCH2_AC1_OUT_gv << EVSYS_ASYNCCH2_gp),  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH2_AC2_OUT_gc      = (EVSYS_ASYNCCH2_AC2_OUT_gv << EVSYS_ASYNCCH2_gp)   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH2_t;

/* Asynchronous Channel 3 Generator Selection bit group values */
typedef enum EVSYS_ASYNCCH3_VALUES_enum
{
    EVSYS_ASYNCCH3_OFF_gv          = 0x00,  /* Off */
    EVSYS_ASYNCCH3_CCL_LUT0_gv     = 0x01,  /* Configurable custom logic LUT0 */
    EVSYS_ASYNCCH3_CCL_LUT1_gv     = 0x02,  /* Configurable custom logic LUT1 */
    EVSYS_ASYNCCH3_AC0_OUT_gv      = 0x03,  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH3_TCD0_CMPBCLR_gv = 0x04,  /* Timer/Counter type D compare B clear */
    EVSYS_ASYNCCH3_TCD0_CMPASET_gv = 0x05,  /* Timer/Counter type D compare A set */
    EVSYS_ASYNCCH3_TCD0_CMPBSET_gv = 0x06,  /* Timer/Counter type D compare B set */
    EVSYS_ASYNCCH3_TCD0_PROGEV_gv  = 0x07,  /* Timer/Counter type D program event */
    EVSYS_ASYNCCH3_RTC_OVF_gv      = 0x08,  /* Real Time Counter overflow */
    EVSYS_ASYNCCH3_RTC_CMP_gv      = 0x09,  /* Real Time Counter compare */
    EVSYS_ASYNCCH3_PIT_DIV8192_gv  = 0x0A,  /* Periodic Interrupt CLK_RTC div 8192 */
    EVSYS_ASYNCCH3_PIT_DIV4096_gv  = 0x0B,  /* Periodic Interrupt CLK_RTC div 4096 */
    EVSYS_ASYNCCH3_PIT_DIV2048_gv  = 0x0C,  /* Periodic Interrupt CLK_RTC div 2048 */
    EVSYS_ASYNCCH3_PIT_DIV1024_gv  = 0x0D,  /* Periodic Interrupt CLK_RTC div 1024 */
    EVSYS_ASYNCCH3_PIT_DIV512_gv   = 0x0E,  /* Periodic Interrupt CLK_RTC div 512 */
    EVSYS_ASYNCCH3_PIT_DIV256_gv   = 0x0F,  /* Periodic Interrupt CLK_RTC div 256 */
    EVSYS_ASYNCCH3_PIT_DIV128_gv   = 0x10,  /* Periodic Interrupt CLK_RTC div 128 */
    EVSYS_ASYNCCH3_PIT_DIV64_gv    = 0x11,  /* Periodic Interrupt CLK_RTC div 64 */
    EVSYS_ASYNCCH3_AC1_OUT_gv      = 0x12,  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH3_AC2_OUT_gv      = 0x13   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH3_values_t;

/* Asynchronous Channel 3 Generator Selection bit group configurations*/
typedef enum EVSYS_ASYNCCH3_enum
{
    EVSYS_ASYNCCH3_OFF_gc          = (EVSYS_ASYNCCH3_OFF_gv << EVSYS_ASYNCCH3_gp),  /* Off */
    EVSYS_ASYNCCH3_CCL_LUT0_gc     = (EVSYS_ASYNCCH3_CCL_LUT0_gv << EVSYS_ASYNCCH3_gp),  /* Configurable custom logic LUT0 */
    EVSYS_ASYNCCH3_CCL_LUT1_gc     = (EVSYS_ASYNCCH3_CCL_LUT1_gv << EVSYS_ASYNCCH3_gp),  /* Configurable custom logic LUT1 */
    EVSYS_ASYNCCH3_AC0_OUT_gc      = (EVSYS_ASYNCCH3_AC0_OUT_gv << EVSYS_ASYNCCH3_gp),  /* Analog Comparator 0 out */
    EVSYS_ASYNCCH3_TCD0_CMPBCLR_gc = (EVSYS_ASYNCCH3_TCD0_CMPBCLR_gv << EVSYS_ASYNCCH3_gp),  /* Timer/Counter type D compare B clear */
    EVSYS_ASYNCCH3_TCD0_CMPASET_gc = (EVSYS_ASYNCCH3_TCD0_CMPASET_gv << EVSYS_ASYNCCH3_gp),  /* Timer/Counter type D compare A set */
    EVSYS_ASYNCCH3_TCD0_CMPBSET_gc = (EVSYS_ASYNCCH3_TCD0_CMPBSET_gv << EVSYS_ASYNCCH3_gp),  /* Timer/Counter type D compare B set */
    EVSYS_ASYNCCH3_TCD0_PROGEV_gc  = (EVSYS_ASYNCCH3_TCD0_PROGEV_gv << EVSYS_ASYNCCH3_gp),  /* Timer/Counter type D program event */
    EVSYS_ASYNCCH3_RTC_OVF_gc      = (EVSYS_ASYNCCH3_RTC_OVF_gv << EVSYS_ASYNCCH3_gp),  /* Real Time Counter overflow */
    EVSYS_ASYNCCH3_RTC_CMP_gc      = (EVSYS_ASYNCCH3_RTC_CMP_gv << EVSYS_ASYNCCH3_gp),  /* Real Time Counter compare */
    EVSYS_ASYNCCH3_PIT_DIV8192_gc  = (EVSYS_ASYNCCH3_PIT_DIV8192_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 8192 */
    EVSYS_ASYNCCH3_PIT_DIV4096_gc  = (EVSYS_ASYNCCH3_PIT_DIV4096_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 4096 */
    EVSYS_ASYNCCH3_PIT_DIV2048_gc  = (EVSYS_ASYNCCH3_PIT_DIV2048_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 2048 */
    EVSYS_ASYNCCH3_PIT_DIV1024_gc  = (EVSYS_ASYNCCH3_PIT_DIV1024_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 1024 */
    EVSYS_ASYNCCH3_PIT_DIV512_gc   = (EVSYS_ASYNCCH3_PIT_DIV512_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 512 */
    EVSYS_ASYNCCH3_PIT_DIV256_gc   = (EVSYS_ASYNCCH3_PIT_DIV256_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 256 */
    EVSYS_ASYNCCH3_PIT_DIV128_gc   = (EVSYS_ASYNCCH3_PIT_DIV128_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 128 */
    EVSYS_ASYNCCH3_PIT_DIV64_gc    = (EVSYS_ASYNCCH3_PIT_DIV64_gv << EVSYS_ASYNCCH3_gp),  /* Periodic Interrupt CLK_RTC div 64 */
    EVSYS_ASYNCCH3_AC1_OUT_gc      = (EVSYS_ASYNCCH3_AC1_OUT_gv << EVSYS_ASYNCCH3_gp),  /* Analog Comparator 1 out */
    EVSYS_ASYNCCH3_AC2_OUT_gc      = (EVSYS_ASYNCCH3_AC2_OUT_gv << EVSYS_ASYNCCH3_gp)   /* Analog Comparator 2 out */
} EVSYS_ASYNCCH3_t;

/* Asynchronous User Ch 0 Input Selection - TCB0 bit group values */
typedef enum EVSYS_ASYNCUSER0_VALUES_enum
{
    EVSYS_ASYNCUSER0_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER0_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER0_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER0_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER0_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER0_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER0_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER0_values_t;

/* Asynchronous User Ch 0 Input Selection - TCB0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER0_enum
{
    EVSYS_ASYNCUSER0_OFF_gc        = (EVSYS_ASYNCUSER0_OFF_gv << EVSYS_ASYNCUSER0_gp),  /* Off */
    EVSYS_ASYNCUSER0_SYNCCH0_gc    = (EVSYS_ASYNCUSER0_SYNCCH0_gv << EVSYS_ASYNCUSER0_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER0_SYNCCH1_gc    = (EVSYS_ASYNCUSER0_SYNCCH1_gv << EVSYS_ASYNCUSER0_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER0_ASYNCCH0_gc   = (EVSYS_ASYNCUSER0_ASYNCCH0_gv << EVSYS_ASYNCUSER0_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER0_ASYNCCH1_gc   = (EVSYS_ASYNCUSER0_ASYNCCH1_gv << EVSYS_ASYNCUSER0_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER0_ASYNCCH2_gc   = (EVSYS_ASYNCUSER0_ASYNCCH2_gv << EVSYS_ASYNCUSER0_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER0_ASYNCCH3_gc   = (EVSYS_ASYNCUSER0_ASYNCCH3_gv << EVSYS_ASYNCUSER0_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER0_t;

/* Asynchronous User Ch 1 Input Selection - ADC0 bit group values */
typedef enum EVSYS_ASYNCUSER1_VALUES_enum
{
    EVSYS_ASYNCUSER1_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER1_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER1_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER1_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER1_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER1_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER1_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER1_values_t;

/* Asynchronous User Ch 1 Input Selection - ADC0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER1_enum
{
    EVSYS_ASYNCUSER1_OFF_gc        = (EVSYS_ASYNCUSER1_OFF_gv << EVSYS_ASYNCUSER1_gp),  /* Off */
    EVSYS_ASYNCUSER1_SYNCCH0_gc    = (EVSYS_ASYNCUSER1_SYNCCH0_gv << EVSYS_ASYNCUSER1_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER1_SYNCCH1_gc    = (EVSYS_ASYNCUSER1_SYNCCH1_gv << EVSYS_ASYNCUSER1_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER1_ASYNCCH0_gc   = (EVSYS_ASYNCUSER1_ASYNCCH0_gv << EVSYS_ASYNCUSER1_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER1_ASYNCCH1_gc   = (EVSYS_ASYNCUSER1_ASYNCCH1_gv << EVSYS_ASYNCUSER1_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER1_ASYNCCH2_gc   = (EVSYS_ASYNCUSER1_ASYNCCH2_gv << EVSYS_ASYNCUSER1_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER1_ASYNCCH3_gc   = (EVSYS_ASYNCUSER1_ASYNCCH3_gv << EVSYS_ASYNCUSER1_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER1_t;

/* Asynchronous User Ch 10 Input Selection - Event Out 2 bit group values */
typedef enum EVSYS_ASYNCUSER10_VALUES_enum
{
    EVSYS_ASYNCUSER10_OFF_gv       = 0x00,  /* Off */
    EVSYS_ASYNCUSER10_SYNCCH0_gv   = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER10_SYNCCH1_gv   = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER10_ASYNCCH0_gv  = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER10_ASYNCCH1_gv  = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER10_ASYNCCH2_gv  = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER10_ASYNCCH3_gv  = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER10_values_t;

/* Asynchronous User Ch 10 Input Selection - Event Out 2 bit group configurations*/
typedef enum EVSYS_ASYNCUSER10_enum
{
    EVSYS_ASYNCUSER10_OFF_gc       = (EVSYS_ASYNCUSER10_OFF_gv << EVSYS_ASYNCUSER10_gp),  /* Off */
    EVSYS_ASYNCUSER10_SYNCCH0_gc   = (EVSYS_ASYNCUSER10_SYNCCH0_gv << EVSYS_ASYNCUSER10_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER10_SYNCCH1_gc   = (EVSYS_ASYNCUSER10_SYNCCH1_gv << EVSYS_ASYNCUSER10_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER10_ASYNCCH0_gc  = (EVSYS_ASYNCUSER10_ASYNCCH0_gv << EVSYS_ASYNCUSER10_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER10_ASYNCCH1_gc  = (EVSYS_ASYNCUSER10_ASYNCCH1_gv << EVSYS_ASYNCUSER10_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER10_ASYNCCH2_gc  = (EVSYS_ASYNCUSER10_ASYNCCH2_gv << EVSYS_ASYNCUSER10_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER10_ASYNCCH3_gc  = (EVSYS_ASYNCUSER10_ASYNCCH3_gv << EVSYS_ASYNCUSER10_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER10_t;

/* Asynchronous User Ch 11 Input Selection - TCB1 bit group values */
typedef enum EVSYS_ASYNCUSER11_VALUES_enum
{
    EVSYS_ASYNCUSER11_OFF_gv       = 0x00,  /* Off */
    EVSYS_ASYNCUSER11_SYNCCH0_gv   = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_SYNCCH1_gv   = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH0_gv  = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_ASYNCCH1_gv  = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH2_gv  = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER11_ASYNCCH3_gv  = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER11_values_t;

/* Asynchronous User Ch 11 Input Selection - TCB1 bit group configurations*/
typedef enum EVSYS_ASYNCUSER11_enum
{
    EVSYS_ASYNCUSER11_OFF_gc       = (EVSYS_ASYNCUSER11_OFF_gv << EVSYS_ASYNCUSER11_gp),  /* Off */
    EVSYS_ASYNCUSER11_SYNCCH0_gc   = (EVSYS_ASYNCUSER11_SYNCCH0_gv << EVSYS_ASYNCUSER11_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_SYNCCH1_gc   = (EVSYS_ASYNCUSER11_SYNCCH1_gv << EVSYS_ASYNCUSER11_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH0_gc  = (EVSYS_ASYNCUSER11_ASYNCCH0_gv << EVSYS_ASYNCUSER11_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_ASYNCCH1_gc  = (EVSYS_ASYNCUSER11_ASYNCCH1_gv << EVSYS_ASYNCUSER11_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH2_gc  = (EVSYS_ASYNCUSER11_ASYNCCH2_gv << EVSYS_ASYNCUSER11_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER11_ASYNCCH3_gc  = (EVSYS_ASYNCUSER11_ASYNCCH3_gv << EVSYS_ASYNCUSER11_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER11_t;

/* Asynchronous User Ch 12 Input Selection - ADC0 bit group values */
typedef enum EVSYS_ASYNCUSER12_VALUES_enum
{
    EVSYS_ASYNCUSER12_OFF_gv       = 0x00,  /* Off */
    EVSYS_ASYNCUSER12_SYNCCH0_gv   = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_SYNCCH1_gv   = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH0_gv  = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_ASYNCCH1_gv  = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH2_gv  = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER12_ASYNCCH3_gv  = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER12_values_t;

/* Asynchronous User Ch 12 Input Selection - ADC0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER12_enum
{
    EVSYS_ASYNCUSER12_OFF_gc       = (EVSYS_ASYNCUSER12_OFF_gv << EVSYS_ASYNCUSER12_gp),  /* Off */
    EVSYS_ASYNCUSER12_SYNCCH0_gc   = (EVSYS_ASYNCUSER12_SYNCCH0_gv << EVSYS_ASYNCUSER12_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_SYNCCH1_gc   = (EVSYS_ASYNCUSER12_SYNCCH1_gv << EVSYS_ASYNCUSER12_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH0_gc  = (EVSYS_ASYNCUSER12_ASYNCCH0_gv << EVSYS_ASYNCUSER12_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_ASYNCCH1_gc  = (EVSYS_ASYNCUSER12_ASYNCCH1_gv << EVSYS_ASYNCUSER12_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH2_gc  = (EVSYS_ASYNCUSER12_ASYNCCH2_gv << EVSYS_ASYNCUSER12_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER12_ASYNCCH3_gc  = (EVSYS_ASYNCUSER12_ASYNCCH3_gv << EVSYS_ASYNCUSER12_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER12_t;

/* Asynchronous User Ch 2 Input Selection - CCL LUT0 Event 0 bit group values */
typedef enum EVSYS_ASYNCUSER2_VALUES_enum
{
    EVSYS_ASYNCUSER2_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER2_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER2_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER2_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER2_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER2_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER2_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER2_values_t;

/* Asynchronous User Ch 2 Input Selection - CCL LUT0 Event 0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER2_enum
{
    EVSYS_ASYNCUSER2_OFF_gc        = (EVSYS_ASYNCUSER2_OFF_gv << EVSYS_ASYNCUSER2_gp),  /* Off */
    EVSYS_ASYNCUSER2_SYNCCH0_gc    = (EVSYS_ASYNCUSER2_SYNCCH0_gv << EVSYS_ASYNCUSER2_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER2_SYNCCH1_gc    = (EVSYS_ASYNCUSER2_SYNCCH1_gv << EVSYS_ASYNCUSER2_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER2_ASYNCCH0_gc   = (EVSYS_ASYNCUSER2_ASYNCCH0_gv << EVSYS_ASYNCUSER2_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER2_ASYNCCH1_gc   = (EVSYS_ASYNCUSER2_ASYNCCH1_gv << EVSYS_ASYNCUSER2_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER2_ASYNCCH2_gc   = (EVSYS_ASYNCUSER2_ASYNCCH2_gv << EVSYS_ASYNCUSER2_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER2_ASYNCCH3_gc   = (EVSYS_ASYNCUSER2_ASYNCCH3_gv << EVSYS_ASYNCUSER2_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER2_t;

/* Asynchronous User Ch 3 Input Selection - CCL LUT1 Event 0 bit group values */
typedef enum EVSYS_ASYNCUSER3_VALUES_enum
{
    EVSYS_ASYNCUSER3_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER3_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER3_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER3_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER3_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER3_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER3_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER3_values_t;

/* Asynchronous User Ch 3 Input Selection - CCL LUT1 Event 0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER3_enum
{
    EVSYS_ASYNCUSER3_OFF_gc        = (EVSYS_ASYNCUSER3_OFF_gv << EVSYS_ASYNCUSER3_gp),  /* Off */
    EVSYS_ASYNCUSER3_SYNCCH0_gc    = (EVSYS_ASYNCUSER3_SYNCCH0_gv << EVSYS_ASYNCUSER3_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER3_SYNCCH1_gc    = (EVSYS_ASYNCUSER3_SYNCCH1_gv << EVSYS_ASYNCUSER3_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER3_ASYNCCH0_gc   = (EVSYS_ASYNCUSER3_ASYNCCH0_gv << EVSYS_ASYNCUSER3_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER3_ASYNCCH1_gc   = (EVSYS_ASYNCUSER3_ASYNCCH1_gv << EVSYS_ASYNCUSER3_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER3_ASYNCCH2_gc   = (EVSYS_ASYNCUSER3_ASYNCCH2_gv << EVSYS_ASYNCUSER3_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER3_ASYNCCH3_gc   = (EVSYS_ASYNCUSER3_ASYNCCH3_gv << EVSYS_ASYNCUSER3_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER3_t;

/* Asynchronous User Ch 4 Input Selection - CCL LUT0 Event 1 bit group values */
typedef enum EVSYS_ASYNCUSER4_VALUES_enum
{
    EVSYS_ASYNCUSER4_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER4_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER4_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER4_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER4_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER4_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER4_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER4_values_t;

/* Asynchronous User Ch 4 Input Selection - CCL LUT0 Event 1 bit group configurations*/
typedef enum EVSYS_ASYNCUSER4_enum
{
    EVSYS_ASYNCUSER4_OFF_gc        = (EVSYS_ASYNCUSER4_OFF_gv << EVSYS_ASYNCUSER4_gp),  /* Off */
    EVSYS_ASYNCUSER4_SYNCCH0_gc    = (EVSYS_ASYNCUSER4_SYNCCH0_gv << EVSYS_ASYNCUSER4_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER4_SYNCCH1_gc    = (EVSYS_ASYNCUSER4_SYNCCH1_gv << EVSYS_ASYNCUSER4_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER4_ASYNCCH0_gc   = (EVSYS_ASYNCUSER4_ASYNCCH0_gv << EVSYS_ASYNCUSER4_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER4_ASYNCCH1_gc   = (EVSYS_ASYNCUSER4_ASYNCCH1_gv << EVSYS_ASYNCUSER4_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER4_ASYNCCH2_gc   = (EVSYS_ASYNCUSER4_ASYNCCH2_gv << EVSYS_ASYNCUSER4_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER4_ASYNCCH3_gc   = (EVSYS_ASYNCUSER4_ASYNCCH3_gv << EVSYS_ASYNCUSER4_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER4_t;

/* Asynchronous User Ch 5 Input Selection - CCL LUT1 Event 1 bit group values */
typedef enum EVSYS_ASYNCUSER5_VALUES_enum
{
    EVSYS_ASYNCUSER5_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER5_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER5_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER5_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER5_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER5_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER5_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER5_values_t;

/* Asynchronous User Ch 5 Input Selection - CCL LUT1 Event 1 bit group configurations*/
typedef enum EVSYS_ASYNCUSER5_enum
{
    EVSYS_ASYNCUSER5_OFF_gc        = (EVSYS_ASYNCUSER5_OFF_gv << EVSYS_ASYNCUSER5_gp),  /* Off */
    EVSYS_ASYNCUSER5_SYNCCH0_gc    = (EVSYS_ASYNCUSER5_SYNCCH0_gv << EVSYS_ASYNCUSER5_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER5_SYNCCH1_gc    = (EVSYS_ASYNCUSER5_SYNCCH1_gv << EVSYS_ASYNCUSER5_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER5_ASYNCCH0_gc   = (EVSYS_ASYNCUSER5_ASYNCCH0_gv << EVSYS_ASYNCUSER5_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER5_ASYNCCH1_gc   = (EVSYS_ASYNCUSER5_ASYNCCH1_gv << EVSYS_ASYNCUSER5_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER5_ASYNCCH2_gc   = (EVSYS_ASYNCUSER5_ASYNCCH2_gv << EVSYS_ASYNCUSER5_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER5_ASYNCCH3_gc   = (EVSYS_ASYNCUSER5_ASYNCCH3_gv << EVSYS_ASYNCUSER5_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER5_t;

/* Asynchronous User Ch 6 Input Selection - TCD0 Event 0 bit group values */
typedef enum EVSYS_ASYNCUSER6_VALUES_enum
{
    EVSYS_ASYNCUSER6_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER6_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER6_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER6_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER6_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER6_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER6_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER6_values_t;

/* Asynchronous User Ch 6 Input Selection - TCD0 Event 0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER6_enum
{
    EVSYS_ASYNCUSER6_OFF_gc        = (EVSYS_ASYNCUSER6_OFF_gv << EVSYS_ASYNCUSER6_gp),  /* Off */
    EVSYS_ASYNCUSER6_SYNCCH0_gc    = (EVSYS_ASYNCUSER6_SYNCCH0_gv << EVSYS_ASYNCUSER6_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER6_SYNCCH1_gc    = (EVSYS_ASYNCUSER6_SYNCCH1_gv << EVSYS_ASYNCUSER6_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER6_ASYNCCH0_gc   = (EVSYS_ASYNCUSER6_ASYNCCH0_gv << EVSYS_ASYNCUSER6_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER6_ASYNCCH1_gc   = (EVSYS_ASYNCUSER6_ASYNCCH1_gv << EVSYS_ASYNCUSER6_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER6_ASYNCCH2_gc   = (EVSYS_ASYNCUSER6_ASYNCCH2_gv << EVSYS_ASYNCUSER6_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER6_ASYNCCH3_gc   = (EVSYS_ASYNCUSER6_ASYNCCH3_gv << EVSYS_ASYNCUSER6_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER6_t;

/* Asynchronous User Ch 7 Input Selection - TCD0 Event 1 bit group values */
typedef enum EVSYS_ASYNCUSER7_VALUES_enum
{
    EVSYS_ASYNCUSER7_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER7_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER7_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER7_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER7_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER7_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER7_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER7_values_t;

/* Asynchronous User Ch 7 Input Selection - TCD0 Event 1 bit group configurations*/
typedef enum EVSYS_ASYNCUSER7_enum
{
    EVSYS_ASYNCUSER7_OFF_gc        = (EVSYS_ASYNCUSER7_OFF_gv << EVSYS_ASYNCUSER7_gp),  /* Off */
    EVSYS_ASYNCUSER7_SYNCCH0_gc    = (EVSYS_ASYNCUSER7_SYNCCH0_gv << EVSYS_ASYNCUSER7_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER7_SYNCCH1_gc    = (EVSYS_ASYNCUSER7_SYNCCH1_gv << EVSYS_ASYNCUSER7_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER7_ASYNCCH0_gc   = (EVSYS_ASYNCUSER7_ASYNCCH0_gv << EVSYS_ASYNCUSER7_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER7_ASYNCCH1_gc   = (EVSYS_ASYNCUSER7_ASYNCCH1_gv << EVSYS_ASYNCUSER7_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER7_ASYNCCH2_gc   = (EVSYS_ASYNCUSER7_ASYNCCH2_gv << EVSYS_ASYNCUSER7_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER7_ASYNCCH3_gc   = (EVSYS_ASYNCUSER7_ASYNCCH3_gv << EVSYS_ASYNCUSER7_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER7_t;

/* Asynchronous User Ch 8 Input Selection - Event Out 0 bit group values */
typedef enum EVSYS_ASYNCUSER8_VALUES_enum
{
    EVSYS_ASYNCUSER8_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER8_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER8_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER8_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER8_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER8_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER8_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER8_values_t;

/* Asynchronous User Ch 8 Input Selection - Event Out 0 bit group configurations*/
typedef enum EVSYS_ASYNCUSER8_enum
{
    EVSYS_ASYNCUSER8_OFF_gc        = (EVSYS_ASYNCUSER8_OFF_gv << EVSYS_ASYNCUSER8_gp),  /* Off */
    EVSYS_ASYNCUSER8_SYNCCH0_gc    = (EVSYS_ASYNCUSER8_SYNCCH0_gv << EVSYS_ASYNCUSER8_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER8_SYNCCH1_gc    = (EVSYS_ASYNCUSER8_SYNCCH1_gv << EVSYS_ASYNCUSER8_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER8_ASYNCCH0_gc   = (EVSYS_ASYNCUSER8_ASYNCCH0_gv << EVSYS_ASYNCUSER8_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER8_ASYNCCH1_gc   = (EVSYS_ASYNCUSER8_ASYNCCH1_gv << EVSYS_ASYNCUSER8_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER8_ASYNCCH2_gc   = (EVSYS_ASYNCUSER8_ASYNCCH2_gv << EVSYS_ASYNCUSER8_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER8_ASYNCCH3_gc   = (EVSYS_ASYNCUSER8_ASYNCCH3_gv << EVSYS_ASYNCUSER8_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER8_t;

/* Asynchronous User Ch 9 Input Selection - Event Out 1 bit group values */
typedef enum EVSYS_ASYNCUSER9_VALUES_enum
{
    EVSYS_ASYNCUSER9_OFF_gv        = 0x00,  /* Off */
    EVSYS_ASYNCUSER9_SYNCCH0_gv    = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER9_SYNCCH1_gv    = 0x02,  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER9_ASYNCCH0_gv   = 0x03,  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER9_ASYNCCH1_gv   = 0x04,  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER9_ASYNCCH2_gv   = 0x05,  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER9_ASYNCCH3_gv   = 0x06   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER9_values_t;

/* Asynchronous User Ch 9 Input Selection - Event Out 1 bit group configurations*/
typedef enum EVSYS_ASYNCUSER9_enum
{
    EVSYS_ASYNCUSER9_OFF_gc        = (EVSYS_ASYNCUSER9_OFF_gv << EVSYS_ASYNCUSER9_gp),  /* Off */
    EVSYS_ASYNCUSER9_SYNCCH0_gc    = (EVSYS_ASYNCUSER9_SYNCCH0_gv << EVSYS_ASYNCUSER9_gp),  /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER9_SYNCCH1_gc    = (EVSYS_ASYNCUSER9_SYNCCH1_gv << EVSYS_ASYNCUSER9_gp),  /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER9_ASYNCCH0_gc   = (EVSYS_ASYNCUSER9_ASYNCCH0_gv << EVSYS_ASYNCUSER9_gp),  /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER9_ASYNCCH1_gc   = (EVSYS_ASYNCUSER9_ASYNCCH1_gv << EVSYS_ASYNCUSER9_gp),  /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER9_ASYNCCH2_gc   = (EVSYS_ASYNCUSER9_ASYNCCH2_gv << EVSYS_ASYNCUSER9_gp),  /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER9_ASYNCCH3_gc   = (EVSYS_ASYNCUSER9_ASYNCCH3_gv << EVSYS_ASYNCUSER9_gp)   /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER9_t;

/* Synchronous Channel 0 Generator Selection bit group values */
typedef enum EVSYS_SYNCCH0_VALUES_enum
{
    EVSYS_SYNCCH0_OFF_gv           = 0x00,  /* Off */
    EVSYS_SYNCCH0_TCB0_gv          = 0x01,  /* Timer/Counter B0 */
    EVSYS_SYNCCH0_TCA0_OVF_LUNF_gv = 0x02,  /* Timer/Counter A0 overflow */
    EVSYS_SYNCCH0_TCA0_HUNF_gv     = 0x03,  /* Timer/Counter A0 underflow high byte (split mode) */
    EVSYS_SYNCCH0_TCA0_CMP0_gv     = 0x04,  /* Timer/Counter A0 compare 0 */
    EVSYS_SYNCCH0_TCA0_CMP1_gv     = 0x05,  /* Timer/Counter A0 compare 1 */
    EVSYS_SYNCCH0_TCA0_CMP2_gv     = 0x06,  /* Timer/Counter A0 compare 2 */
    EVSYS_SYNCCH0_PORTC_PIN0_gv    = 0x07,  /* Synchronous Event from Pin PC0 */
    EVSYS_SYNCCH0_PORTC_PIN1_gv    = 0x08,  /* Synchronous Event from Pin PC1 */
    EVSYS_SYNCCH0_PORTC_PIN2_gv    = 0x09,  /* Synchronous Event from Pin PC2 */
    EVSYS_SYNCCH0_PORTC_PIN3_gv    = 0x0A,  /* Synchronous Event from Pin PC3 */
    EVSYS_SYNCCH0_PORTC_PIN4_gv    = 0x0B,  /* Synchronous Event from Pin PC4 */
    EVSYS_SYNCCH0_PORTC_PIN5_gv    = 0x0C,  /* Synchronous Event from Pin PC5 */
    EVSYS_SYNCCH0_PORTA_PIN0_gv    = 0x0D,  /* Synchronous Event from Pin PA0 */
    EVSYS_SYNCCH0_PORTA_PIN1_gv    = 0x0E,  /* Synchronous Event from Pin PA1 */
    EVSYS_SYNCCH0_PORTA_PIN2_gv    = 0x0F,  /* Synchronous Event from Pin PA2 */
    EVSYS_SYNCCH0_PORTA_PIN3_gv    = 0x10,  /* Synchronous Event from Pin PA3 */
    EVSYS_SYNCCH0_PORTA_PIN4_gv    = 0x11,  /* Synchronous Event from Pin PA4 */
    EVSYS_SYNCCH0_PORTA_PIN5_gv    = 0x12,  /* Synchronous Event from Pin PA5 */
    EVSYS_SYNCCH0_PORTA_PIN6_gv    = 0x13,  /* Synchronous Event from Pin PA6 */
    EVSYS_SYNCCH0_PORTA_PIN7_gv    = 0x14,  /* Synchronous Event from Pin PA7 */
    EVSYS_SYNCCH0_TCB1_gv          = 0x15   /* Timer/Counter B1 */
} EVSYS_SYNCCH0_values_t;

/* Synchronous Channel 0 Generator Selection bit group configurations*/
typedef enum EVSYS_SYNCCH0_enum
{
    EVSYS_SYNCCH0_OFF_gc           = (EVSYS_SYNCCH0_OFF_gv << EVSYS_SYNCCH0_gp),  /* Off */
    EVSYS_SYNCCH0_TCB0_gc          = (EVSYS_SYNCCH0_TCB0_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter B0 */
    EVSYS_SYNCCH0_TCA0_OVF_LUNF_gc = (EVSYS_SYNCCH0_TCA0_OVF_LUNF_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter A0 overflow */
    EVSYS_SYNCCH0_TCA0_HUNF_gc     = (EVSYS_SYNCCH0_TCA0_HUNF_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter A0 underflow high byte (split mode) */
    EVSYS_SYNCCH0_TCA0_CMP0_gc     = (EVSYS_SYNCCH0_TCA0_CMP0_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter A0 compare 0 */
    EVSYS_SYNCCH0_TCA0_CMP1_gc     = (EVSYS_SYNCCH0_TCA0_CMP1_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter A0 compare 1 */
    EVSYS_SYNCCH0_TCA0_CMP2_gc     = (EVSYS_SYNCCH0_TCA0_CMP2_gv << EVSYS_SYNCCH0_gp),  /* Timer/Counter A0 compare 2 */
    EVSYS_SYNCCH0_PORTC_PIN0_gc    = (EVSYS_SYNCCH0_PORTC_PIN0_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC0 */
    EVSYS_SYNCCH0_PORTC_PIN1_gc    = (EVSYS_SYNCCH0_PORTC_PIN1_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC1 */
    EVSYS_SYNCCH0_PORTC_PIN2_gc    = (EVSYS_SYNCCH0_PORTC_PIN2_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC2 */
    EVSYS_SYNCCH0_PORTC_PIN3_gc    = (EVSYS_SYNCCH0_PORTC_PIN3_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC3 */
    EVSYS_SYNCCH0_PORTC_PIN4_gc    = (EVSYS_SYNCCH0_PORTC_PIN4_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC4 */
    EVSYS_SYNCCH0_PORTC_PIN5_gc    = (EVSYS_SYNCCH0_PORTC_PIN5_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PC5 */
    EVSYS_SYNCCH0_PORTA_PIN0_gc    = (EVSYS_SYNCCH0_PORTA_PIN0_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA0 */
    EVSYS_SYNCCH0_PORTA_PIN1_gc    = (EVSYS_SYNCCH0_PORTA_PIN1_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA1 */
    EVSYS_SYNCCH0_PORTA_PIN2_gc    = (EVSYS_SYNCCH0_PORTA_PIN2_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA2 */
    EVSYS_SYNCCH0_PORTA_PIN3_gc    = (EVSYS_SYNCCH0_PORTA_PIN3_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA3 */
    EVSYS_SYNCCH0_PORTA_PIN4_gc    = (EVSYS_SYNCCH0_PORTA_PIN4_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA4 */
    EVSYS_SYNCCH0_PORTA_PIN5_gc    = (EVSYS_SYNCCH0_PORTA_PIN5_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA5 */
    EVSYS_SYNCCH0_PORTA_PIN6_gc    = (EVSYS_SYNCCH0_PORTA_PIN6_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA6 */
    EVSYS_SYNCCH0_PORTA_PIN7_gc    = (EVSYS_SYNCCH0_PORTA_PIN7_gv << EVSYS_SYNCCH0_gp),  /* Synchronous Event from Pin PA7 */
    EVSYS_SYNCCH0_TCB1_gc          = (EVSYS_SYNCCH0_TCB1_gv << EVSYS_SYNCCH0_gp)   /* Timer/Counter B1 */
} EVSYS_SYNCCH0_t;

/* Synchronous Channel 1 Generator Selection bit group values */
typedef enum EVSYS_SYNCCH1_VALUES_enum
{
    EVSYS_SYNCCH1_OFF_gv           = 0x00,  /* Off */
    EVSYS_SYNCCH1_TCB0_gv          = 0x01,  /* Timer/Counter B0 */
    EVSYS_SYNCCH1_TCA0_OVF_LUNF_gv = 0x02,  /* Timer/Counter A0 overflow */
    EVSYS_SYNCCH1_TCA0_HUNF_gv     = 0x03,  /* Timer/Counter A0 underflow high byte (split mode) */
    EVSYS_SYNCCH1_TCA0_CMP0_gv     = 0x04,  /* Timer/Counter A0 compare 0 */
    EVSYS_SYNCCH1_TCA0_CMP1_gv     = 0x05,  /* Timer/Counter A0 compare 1 */
    EVSYS_SYNCCH1_TCA0_CMP2_gv     = 0x06,  /* Timer/Counter A0 compare 2 */
    EVSYS_SYNCCH1_PORTB_PIN0_gv    = 0x08,  /* Synchronous Event from Pin PB0 */
    EVSYS_SYNCCH1_PORTB_PIN1_gv    = 0x09,  /* Synchronous Event from Pin PB1 */
    EVSYS_SYNCCH1_PORTB_PIN2_gv    = 0x0A,  /* Synchronous Event from Pin PB2 */
    EVSYS_SYNCCH1_PORTB_PIN3_gv    = 0x0B,  /* Synchronous Event from Pin PB3 */
    EVSYS_SYNCCH1_PORTB_PIN4_gv    = 0x0C,  /* Synchronous Event from Pin PB4 */
    EVSYS_SYNCCH1_PORTB_PIN5_gv    = 0x0D,  /* Synchronous Event from Pin PB5 */
    EVSYS_SYNCCH1_PORTB_PIN6_gv    = 0x0E,  /* Synchronous Event from Pin PB6 */
    EVSYS_SYNCCH1_PORTB_PIN7_gv    = 0x0F,  /* Synchronous Event from Pin PB7 */
    EVSYS_SYNCCH1_TCB1_gv          = 0x10   /* Timer/Counter B1 */
} EVSYS_SYNCCH1_values_t;

/* Synchronous Channel 1 Generator Selection bit group configurations*/
typedef enum EVSYS_SYNCCH1_enum
{
    EVSYS_SYNCCH1_OFF_gc           = (EVSYS_SYNCCH1_OFF_gv << EVSYS_SYNCCH1_gp),  /* Off */
    EVSYS_SYNCCH1_TCB0_gc          = (EVSYS_SYNCCH1_TCB0_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter B0 */
    EVSYS_SYNCCH1_TCA0_OVF_LUNF_gc = (EVSYS_SYNCCH1_TCA0_OVF_LUNF_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter A0 overflow */
    EVSYS_SYNCCH1_TCA0_HUNF_gc     = (EVSYS_SYNCCH1_TCA0_HUNF_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter A0 underflow high byte (split mode) */
    EVSYS_SYNCCH1_TCA0_CMP0_gc     = (EVSYS_SYNCCH1_TCA0_CMP0_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter A0 compare 0 */
    EVSYS_SYNCCH1_TCA0_CMP1_gc     = (EVSYS_SYNCCH1_TCA0_CMP1_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter A0 compare 1 */
    EVSYS_SYNCCH1_TCA0_CMP2_gc     = (EVSYS_SYNCCH1_TCA0_CMP2_gv << EVSYS_SYNCCH1_gp),  /* Timer/Counter A0 compare 2 */
    EVSYS_SYNCCH1_PORTB_PIN0_gc    = (EVSYS_SYNCCH1_PORTB_PIN0_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB0 */
    EVSYS_SYNCCH1_PORTB_PIN1_gc    = (EVSYS_SYNCCH1_PORTB_PIN1_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB1 */
    EVSYS_SYNCCH1_PORTB_PIN2_gc    = (EVSYS_SYNCCH1_PORTB_PIN2_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB2 */
    EVSYS_SYNCCH1_PORTB_PIN3_gc    = (EVSYS_SYNCCH1_PORTB_PIN3_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB3 */
    EVSYS_SYNCCH1_PORTB_PIN4_gc    = (EVSYS_SYNCCH1_PORTB_PIN4_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB4 */
    EVSYS_SYNCCH1_PORTB_PIN5_gc    = (EVSYS_SYNCCH1_PORTB_PIN5_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB5 */
    EVSYS_SYNCCH1_PORTB_PIN6_gc    = (EVSYS_SYNCCH1_PORTB_PIN6_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB6 */
    EVSYS_SYNCCH1_PORTB_PIN7_gc    = (EVSYS_SYNCCH1_PORTB_PIN7_gv << EVSYS_SYNCCH1_gp),  /* Synchronous Event from Pin PB7 */
    EVSYS_SYNCCH1_TCB1_gc          = (EVSYS_SYNCCH1_TCB1_gv << EVSYS_SYNCCH1_gp)   /* Timer/Counter B1 */
} EVSYS_SYNCCH1_t;

/* Synchronous User Ch 0 - TCA0 select bit group values */
typedef enum EVSYS_SYNCUSER0_VALUES_enum
{
    EVSYS_SYNCUSER0_OFF_gv         = 0x00,  /* Off */
    EVSYS_SYNCUSER0_SYNCCH0_gv     = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_SYNCUSER0_SYNCCH1_gv     = 0x02   /* Synchronous Event Channel 1 */
} EVSYS_SYNCUSER0_values_t;

/* Synchronous User Ch 0 - TCA0 select bit group configurations*/
typedef enum EVSYS_SYNCUSER0_enum
{
    EVSYS_SYNCUSER0_OFF_gc         = (EVSYS_SYNCUSER0_OFF_gv << EVSYS_SYNCUSER0_gp),  /* Off */
    EVSYS_SYNCUSER0_SYNCCH0_gc     = (EVSYS_SYNCUSER0_SYNCCH0_gv << EVSYS_SYNCUSER0_gp),  /* Synchronous Event Channel 0 */
    EVSYS_SYNCUSER0_SYNCCH1_gc     = (EVSYS_SYNCUSER0_SYNCCH1_gv << EVSYS_SYNCUSER0_gp)   /* Synchronous Event Channel 1 */
} EVSYS_SYNCUSER0_t;

/* Synchronous User Ch 1 - USART0 select bit group values */
typedef enum EVSYS_SYNCUSER1_VALUES_enum
{
    EVSYS_SYNCUSER1_OFF_gv         = 0x00,  /* Off */
    EVSYS_SYNCUSER1_SYNCCH0_gv     = 0x01,  /* Synchronous Event Channel 0 */
    EVSYS_SYNCUSER1_SYNCCH1_gv     = 0x02   /* Synchronous Event Channel 1 */
} EVSYS_SYNCUSER1_values_t;

/* Synchronous User Ch 1 - USART0 select bit group configurations*/
typedef enum EVSYS_SYNCUSER1_enum
{
    EVSYS_SYNCUSER1_OFF_gc         = (EVSYS_SYNCUSER1_OFF_gv << EVSYS_SYNCUSER1_gp),  /* Off */
    EVSYS_SYNCUSER1_SYNCCH0_gc     = (EVSYS_SYNCUSER1_SYNCCH0_gv << EVSYS_SYNCUSER1_gp),  /* Synchronous Event Channel 0 */
    EVSYS_SYNCUSER1_SYNCCH1_gc     = (EVSYS_SYNCUSER1_SYNCCH1_gv << EVSYS_SYNCUSER1_gp)   /* Synchronous Event Channel 1 */
} EVSYS_SYNCUSER1_t;
...
typedef enum RSTPINCFG_VALUES_enum
{
    ...
    RSTPINCFG_UPDI_gv              = 0x01,  /* UPDI mode */
    RSTPINCFG_RST_gv               = 0x02   /* Reset mode */
} RSTPINCFG_values_t;

/* Reset Pin Configuration select bit group configurations*/
typedef enum RSTPINCFG_enum
{
    RSTPINCFG_GPIO_gc              = (RSTPINCFG_GPIO_gv << FUSE_RSTPINCFG_gp),  /* GPIO mode */
    RSTPINCFG_UPDI_gc              = (RSTPINCFG_UPDI_gv << FUSE_RSTPINCFG_gp),  /* UPDI mode */
    RSTPINCFG_RST_gc               = (RSTPINCFG_RST_gv << FUSE_RSTPINCFG_gp)   /* Reset mode */
} RSTPINCFG_t;
...
/* Lock Bits select bit group values */
typedef enum LB_VALUES_enum
{
    LB_RWLOCK_gv                   = 0x3A,  /* Read and write lock */
    LB_NOLOCK_gv                   = 0xC5   /* No locks */
} LB_values_t;

/* Lock Bits select bit group configurations*/
typedef enum LB_enum
{
    LB_RWLOCK_gc                   = (LB_RWLOCK_gv << LOCKBIT_LB_gp),  /* Read and write lock */
    LB_NOLOCK_gc                   = (LB_NOLOCK_gv << LOCKBIT_LB_gp)   /* No locks */
} LB_t;
...
/* Configurable Custom Logic LUT0 select bit group values */
typedef enum PORTMUX_LUT0_VALUES_enum
{
    PORTMUX_LUT0_DEFAULT_gv        = 0x00,  /* Default pin */
    PORTMUX_LUT0_ALTERNATE_gv      = 0x01   /* Alternate pin */
} PORTMUX_LUT0_values_t;

/* Configurable Custom Logic LUT0 select bit group configurations*/
typedef enum PORTMUX_LUT0_enum
{
    PORTMUX_LUT0_DEFAULT_gc        = (PORTMUX_LUT0_DEFAULT_gv << PORTMUX_LUT0_bp),  /* Default pin */
    PORTMUX_LUT0_ALTERNATE_gc      = (PORTMUX_LUT0_ALTERNATE_gv << PORTMUX_LUT0_bp)   /* Alternate pin */
} PORTMUX_LUT0_t;

/* Configurable Custom Logic LUT1 select bit group values */
typedef enum PORTMUX_LUT1_VALUES_enum
{
    PORTMUX_LUT1_DEFAULT_gv        = 0x00,  /* Default pin */
    PORTMUX_LUT1_ALTERNATE_gv      = 0x01   /* Alternate pin */
} PORTMUX_LUT1_values_t;

/* Configurable Custom Logic LUT1 select bit group configurations*/
typedef enum PORTMUX_LUT1_enum
{
    PORTMUX_LUT1_DEFAULT_gc        = (PORTMUX_LUT1_DEFAULT_gv << PORTMUX_LUT1_bp),  /* Default pin */
    PORTMUX_LUT1_ALTERNATE_gc      = (PORTMUX_LUT1_ALTERNATE_gv << PORTMUX_LUT1_bp)   /* Alternate pin */
} PORTMUX_LUT1_t;

/* Port Multiplexer SPI0 select bit group values */
typedef enum PORTMUX_SPI0_VALUES_enum
{
    PORTMUX_SPI0_DEFAULT_gv        = 0x00,  /* Default pins */
    PORTMUX_SPI0_ALTERNATE_gv      = 0x01   /* Alternate pins */
} PORTMUX_SPI0_values_t;

/* Port Multiplexer SPI0 select bit group configurations*/
typedef enum PORTMUX_SPI0_enum
{
    PORTMUX_SPI0_DEFAULT_gc        = (PORTMUX_SPI0_DEFAULT_gv << PORTMUX_SPI0_bp),  /* Default pins */
    PORTMUX_SPI0_ALTERNATE_gc      = (PORTMUX_SPI0_ALTERNATE_gv << PORTMUX_SPI0_bp)   /* Alternate pins */
} PORTMUX_SPI0_t;

/* Port Multiplexer TCA0 Output 0 select bit group values */
typedef enum PORTMUX_TCA00_VALUES_enum
{
    PORTMUX_TCA00_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA00_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA00_values_t;

/* Port Multiplexer TCA0 Output 0 select bit group configurations*/
typedef enum PORTMUX_TCA00_enum
{
    PORTMUX_TCA00_DEFAULT_gc       = (PORTMUX_TCA00_DEFAULT_gv << PORTMUX_TCA00_bp),  /* Default pin */
    PORTMUX_TCA00_ALTERNATE_gc     = (PORTMUX_TCA00_ALTERNATE_gv << PORTMUX_TCA00_bp)   /* Alternate pin */
} PORTMUX_TCA00_t;

/* Port Multiplexer TCA0 Output 1 select bit group values */
typedef enum PORTMUX_TCA01_VALUES_enum
{
    PORTMUX_TCA01_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA01_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA01_values_t;

/* Port Multiplexer TCA0 Output 1 select bit group configurations*/
typedef enum PORTMUX_TCA01_enum
{
    PORTMUX_TCA01_DEFAULT_gc       = (PORTMUX_TCA01_DEFAULT_gv << PORTMUX_TCA01_bp),  /* Default pin */
    PORTMUX_TCA01_ALTERNATE_gc     = (PORTMUX_TCA01_ALTERNATE_gv << PORTMUX_TCA01_bp)   /* Alternate pin */
} PORTMUX_TCA01_t;

/* Port Multiplexer TCA0 Output 2 select bit group values */
typedef enum PORTMUX_TCA02_VALUES_enum
{
    PORTMUX_TCA02_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA02_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA02_values_t;

/* Port Multiplexer TCA0 Output 2 select bit group configurations*/
typedef enum PORTMUX_TCA02_enum
{
    PORTMUX_TCA02_DEFAULT_gc       = (PORTMUX_TCA02_DEFAULT_gv << PORTMUX_TCA02_bp),  /* Default pin */
    PORTMUX_TCA02_ALTERNATE_gc     = (PORTMUX_TCA02_ALTERNATE_gv << PORTMUX_TCA02_bp)   /* Alternate pin */
} PORTMUX_TCA02_t;

/* Port Multiplexer TCA0 Output 3 select bit group values */
typedef enum PORTMUX_TCA03_VALUES_enum
{
    PORTMUX_TCA03_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA03_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA03_values_t;

/* Port Multiplexer TCA0 Output 3 select bit group configurations*/
typedef enum PORTMUX_TCA03_enum
{
    PORTMUX_TCA03_DEFAULT_gc       = (PORTMUX_TCA03_DEFAULT_gv << PORTMUX_TCA03_bp),  /* Default pin */
    PORTMUX_TCA03_ALTERNATE_gc     = (PORTMUX_TCA03_ALTERNATE_gv << PORTMUX_TCA03_bp)   /* Alternate pin */
} PORTMUX_TCA03_t;

/* Port Multiplexer TCA0 Output 4 select bit group values */
typedef enum PORTMUX_TCA04_VALUES_enum
{
    PORTMUX_TCA04_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA04_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA04_values_t;

/* Port Multiplexer TCA0 Output 4 select bit group configurations*/
typedef enum PORTMUX_TCA04_enum
{
    PORTMUX_TCA04_DEFAULT_gc       = (PORTMUX_TCA04_DEFAULT_gv << PORTMUX_TCA04_bp),  /* Default pin */
    PORTMUX_TCA04_ALTERNATE_gc     = (PORTMUX_TCA04_ALTERNATE_gv << PORTMUX_TCA04_bp)   /* Alternate pin */
} PORTMUX_TCA04_t;

/* Port Multiplexer TCA0 Output 5 select bit group values */
typedef enum PORTMUX_TCA05_VALUES_enum
{
    PORTMUX_TCA05_DEFAULT_gv       = 0x00,  /* Default pin */
    PORTMUX_TCA05_ALTERNATE_gv     = 0x01   /* Alternate pin */
} PORTMUX_TCA05_values_t;

/* Port Multiplexer TCA0 Output 5 select bit group configurations*/
typedef enum PORTMUX_TCA05_enum
{
    PORTMUX_TCA05_DEFAULT_gc       = (PORTMUX_TCA05_DEFAULT_gv << PORTMUX_TCA05_bp),  /* Default pin */
    PORTMUX_TCA05_ALTERNATE_gc     = (PORTMUX_TCA05_ALTERNATE_gv << PORTMUX_TCA05_bp)   /* Alternate pin */
} PORTMUX_TCA05_t;

/* Port Multiplexer TCB0 select bit group values */
typedef enum PORTMUX_TCB0_VALUES_enum
{
    PORTMUX_TCB0_DEFAULT_gv        = 0x00,  /* Default pin */
    PORTMUX_TCB0_ALTERNATE_gv      = 0x01   /* Alternate pin */
} PORTMUX_TCB0_values_t;

/* Port Multiplexer TCB0 select bit group configurations*/
typedef enum PORTMUX_TCB0_enum
{
    PORTMUX_TCB0_DEFAULT_gc        = (PORTMUX_TCB0_DEFAULT_gv << PORTMUX_TCB0_bp),  /* Default pin */
    PORTMUX_TCB0_ALTERNATE_gc      = (PORTMUX_TCB0_ALTERNATE_gv << PORTMUX_TCB0_bp)   /* Alternate pin */
} PORTMUX_TCB0_t;

/* Port Multiplexer TCB1 select bit group values */
typedef enum PORTMUX_TCB1_VALUES_enum
{
    PORTMUX_TCB1_DEFAULT_gv        = 0x00,  /* Default pin */
    PORTMUX_TCB1_ALTERNATE_gv      = 0x01   /* Alternate pin */
} PORTMUX_TCB1_values_t;

/* Port Multiplexer TCB1 select bit group configurations*/
typedef enum PORTMUX_TCB1_enum
{
    PORTMUX_TCB1_DEFAULT_gc        = (PORTMUX_TCB1_DEFAULT_gv << PORTMUX_TCB1_bp),  /* Default pin */
    PORTMUX_TCB1_ALTERNATE_gc      = (PORTMUX_TCB1_ALTERNATE_gv << PORTMUX_TCB1_bp)   /* Alternate pin */
} PORTMUX_TCB1_t;

/* Port Multiplexer TWI0 select bit group values */
typedef enum PORTMUX_TWI0_VALUES_enum
{
    PORTMUX_TWI0_DEFAULT_gv        = 0x00,  /* Default pins */
    PORTMUX_TWI0_ALTERNATE_gv      = 0x01   /* Alternate pins */
} PORTMUX_TWI0_values_t;

/* Port Multiplexer TWI0 select bit group configurations*/
typedef enum PORTMUX_TWI0_enum
{
    PORTMUX_TWI0_DEFAULT_gc        = (PORTMUX_TWI0_DEFAULT_gv << PORTMUX_TWI0_bp),  /* Default pins */
    PORTMUX_TWI0_ALTERNATE_gc      = (PORTMUX_TWI0_ALTERNATE_gv << PORTMUX_TWI0_bp)   /* Alternate pins */
} PORTMUX_TWI0_t;

/* Port Multiplexer USART0 select bit group values */
typedef enum PORTMUX_USART0_VALUES_enum
{
    PORTMUX_USART0_DEFAULT_gv      = 0x00,  /* Default pins */
    PORTMUX_USART0_ALTERNATE_gv    = 0x01   /* Alternate pins */
} PORTMUX_USART0_values_t;

/* Port Multiplexer USART0 select bit group configurations*/
typedef enum PORTMUX_USART0_enum
{
    PORTMUX_USART0_DEFAULT_gc      = (PORTMUX_USART0_DEFAULT_gv << PORTMUX_USART0_bp),  /* Default pins */
    PORTMUX_USART0_ALTERNATE_gc    = (PORTMUX_USART0_ALTERNATE_gv << PORTMUX_USART0_bp)   /* Alternate pins */
} PORTMUX_USART0_t;
...
{
    SPI_PRESC_DIV4_gv              = 0x00,  /* System Clock / 4 */
    SPI_PRESC_DIV16_gv             = 0x01,  /* System Clock / 16 */
    SPI_PRESC_DIV64_gv             = 0x02,  /* System Clock / 64 */
    SPI_PRESC_DIV128_gv            = 0x03   /* System Clock / 128 */
} SPI_PRESC_values_t;

/* Prescaler select bit group configurations*/
typedef enum SPI_PRESC_enum
{
    SPI_PRESC_DIV4_gc              = (SPI_PRESC_DIV4_gv << SPI_PRESC_gp),  /* System Clock / 4 */
    SPI_PRESC_DIV16_gc             = (SPI_PRESC_DIV16_gv << SPI_PRESC_gp),  /* System Clock / 16 */
    SPI_PRESC_DIV64_gc             = (SPI_PRESC_DIV64_gv << SPI_PRESC_gp),  /* System Clock / 64 */
    SPI_PRESC_DIV128_gc            = (SPI_PRESC_DIV128_gv << SPI_PRESC_gp)   /* System Clock / 128 */
} SPI_PRESC_t;
...
{
    TCA_SINGLE_CLKSEL_DIV1_gv      = 0x00,  /* System Clock */
    TCA_SINGLE_CLKSEL_DIV2_gv      = 0x01,  /* System Clock / 2 */
    TCA_SINGLE_CLKSEL_DIV4_gv      = 0x02,  /* System Clock / 4 */
    TCA_SINGLE_CLKSEL_DIV8_gv      = 0x03,  /* System Clock / 8 */
    TCA_SINGLE_CLKSEL_DIV16_gv     = 0x04,  /* System Clock / 16 */
    TCA_SINGLE_CLKSEL_DIV64_gv     = 0x05,  /* System Clock / 64 */
    TCA_SINGLE_CLKSEL_DIV256_gv    = 0x06,  /* System Clock / 256 */
    TCA_SINGLE_CLKSEL_DIV1024_gv   = 0x07   /* System Clock / 1024 */
} TCA_SINGLE_CLKSEL_values_t;

/* Clock Selection bit group configurations*/
typedef enum TCA_SINGLE_CLKSEL_enum
{
    TCA_SINGLE_CLKSEL_DIV1_gc      = (TCA_SINGLE_CLKSEL_DIV1_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock */
    TCA_SINGLE_CLKSEL_DIV2_gc      = (TCA_SINGLE_CLKSEL_DIV2_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 2 */
    TCA_SINGLE_CLKSEL_DIV4_gc      = (TCA_SINGLE_CLKSEL_DIV4_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 4 */
    TCA_SINGLE_CLKSEL_DIV8_gc      = (TCA_SINGLE_CLKSEL_DIV8_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 8 */
    TCA_SINGLE_CLKSEL_DIV16_gc     = (TCA_SINGLE_CLKSEL_DIV16_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 16 */
    TCA_SINGLE_CLKSEL_DIV64_gc     = (TCA_SINGLE_CLKSEL_DIV64_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 64 */
    TCA_SINGLE_CLKSEL_DIV256_gc    = (TCA_SINGLE_CLKSEL_DIV256_gv << TCA_SINGLE_CLKSEL_gp),  /* System Clock / 256 */
    TCA_SINGLE_CLKSEL_DIV1024_gc   = (TCA_SINGLE_CLKSEL_DIV1024_gv << TCA_SINGLE_CLKSEL_gp)   /* System Clock / 1024 */
} TCA_SINGLE_CLKSEL_t;
...
typedef enum TCA_SINGLE_EVACT_VALUES_enum
{
    TCA_SINGLE_EVACT_POSEDGE_gv    = 0x00,  /* Count on positive edge event */
    TCA_SINGLE_EVACT_ANYEDGE_gv    = 0x01,  /* Count on any edge event */
    TCA_SINGLE_EVACT_HIGHLVL_gv    = 0x02,  /* Count on prescaled clock while event line is 1. */
    TCA_SINGLE_EVACT_UPDOWN_gv     = 0x03   /* Count on prescaled clock. Event controls count direction. Up-count when event line is 0, down-count when event line is 1. */
} TCA_SINGLE_EVACT_values_t;

/* Event Action select bit group configurations*/
typedef enum TCA_SINGLE_EVACT_enum
{
    TCA_SINGLE_EVACT_POSEDGE_gc    = (TCA_SINGLE_EVACT_POSEDGE_gv << TCA_SINGLE_EVACT_gp),  /* Count on positive edge event */
    TCA_SINGLE_EVACT_ANYEDGE_gc    = (TCA_SINGLE_EVACT_ANYEDGE_gv << TCA_SINGLE_EVACT_gp),  /* Count on any edge event */
    TCA_SINGLE_EVACT_HIGHLVL_gc    = (TCA_SINGLE_EVACT_HIGHLVL_gv << TCA_SINGLE_EVACT_gp),  /* Count on prescaled clock while event line is 1. */
    TCA_SINGLE_EVACT_UPDOWN_gc     = (TCA_SINGLE_EVACT_UPDOWN_gv << TCA_SINGLE_EVACT_gp)   /* Count on prescaled clock. Event controls count direction. Up-count when event line is 0, down-count when event line is 1. */
} TCA_SINGLE_EVACT_t;
...
{
    TCA_SPLIT_CLKSEL_DIV1_gv       = 0x00,  /* System Clock */
    TCA_SPLIT_CLKSEL_DIV2_gv       = 0x01,  /* System Clock / 2 */
    TCA_SPLIT_CLKSEL_DIV4_gv       = 0x02,  /* System Clock / 4 */
    TCA_SPLIT_CLKSEL_DIV8_gv       = 0x03,  /* System Clock / 8 */
    TCA_SPLIT_CLKSEL_DIV16_gv      = 0x04,  /* System Clock / 16 */
    TCA_SPLIT_CLKSEL_DIV64_gv      = 0x05,  /* System Clock / 64 */
    TCA_SPLIT_CLKSEL_DIV256_gv     = 0x06,  /* System Clock / 256 */
    TCA_SPLIT_CLKSEL_DIV1024_gv    = 0x07   /* System Clock / 1024 */
} TCA_SPLIT_CLKSEL_values_t;

/* Clock Selection bit group configurations*/
typedef enum TCA_SPLIT_CLKSEL_enum
{
    TCA_SPLIT_CLKSEL_DIV1_gc       = (TCA_SPLIT_CLKSEL_DIV1_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock */
    TCA_SPLIT_CLKSEL_DIV2_gc       = (TCA_SPLIT_CLKSEL_DIV2_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 2 */
    TCA_SPLIT_CLKSEL_DIV4_gc       = (TCA_SPLIT_CLKSEL_DIV4_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 4 */
    TCA_SPLIT_CLKSEL_DIV8_gc       = (TCA_SPLIT_CLKSEL_DIV8_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 8 */
    TCA_SPLIT_CLKSEL_DIV16_gc      = (TCA_SPLIT_CLKSEL_DIV16_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 16 */
    TCA_SPLIT_CLKSEL_DIV64_gc      = (TCA_SPLIT_CLKSEL_DIV64_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 64 */
    TCA_SPLIT_CLKSEL_DIV256_gc     = (TCA_SPLIT_CLKSEL_DIV256_gv << TCA_SPLIT_CLKSEL_gp),  /* System Clock / 256 */
    TCA_SPLIT_CLKSEL_DIV1024_gc    = (TCA_SPLIT_CLKSEL_DIV1024_gv << TCA_SPLIT_CLKSEL_gp)   /* System Clock / 1024 */
} TCA_SPLIT_CLKSEL_t;
...
{
    TCB_CLKSEL_CLKDIV1_gv          = 0x00,  /* CLK_PER (No Prescaling) */
    TCB_CLKSEL_CLKDIV2_gv          = 0x01,  /* CLK_PER/2 (From Prescaler) */
    TCB_CLKSEL_CLKTCA_gv           = 0x02   /* Use Clock from TCA */
} TCB_CLKSEL_values_t;

/* Clock Select bit group configurations*/
typedef enum TCB_CLKSEL_enum
{
    TCB_CLKSEL_CLKDIV1_gc          = (TCB_CLKSEL_CLKDIV1_gv << TCB_CLKSEL_gp),  /* CLK_PER (No Prescaling) */
    TCB_CLKSEL_CLKDIV2_gc          = (TCB_CLKSEL_CLKDIV2_gv << TCB_CLKSEL_gp),  /* CLK_PER/2 (From Prescaler) */
    TCB_CLKSEL_CLKTCA_gc           = (TCB_CLKSEL_CLKTCA_gv << TCB_CLKSEL_gp)   /* Use Clock from TCA */
} TCB_CLKSEL_t;
...
/* ADC0 reference select bit group values */
typedef enum VREF_ADC0REFSEL_VALUES_enum
{
    VREF_ADC0REFSEL_0V55_gv        = 0x00,  /* Voltage reference at 0.55V */
    VREF_ADC0REFSEL_1V1_gv         = 0x01,  /* Voltage reference at 1.1V */
    VREF_ADC0REFSEL_2V5_gv         = 0x02,  /* Voltage reference at 2.5V */
    VREF_ADC0REFSEL_4V34_gv        = 0x03,  /* Voltage reference at 4.34V */
    VREF_ADC0REFSEL_1V5_gv         = 0x04   /* Voltage reference at 1.5V */
} VREF_ADC0REFSEL_values_t;

/* ADC0 reference select bit group configurations*/
typedef enum VREF_ADC0REFSEL_enum
{
    VREF_ADC0REFSEL_0V55_gc        = (VREF_ADC0REFSEL_0V55_gv << VREF_ADC0REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_ADC0REFSEL_1V1_gc         = (VREF_ADC0REFSEL_1V1_gv << VREF_ADC0REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_ADC0REFSEL_2V5_gc         = (VREF_ADC0REFSEL_2V5_gv << VREF_ADC0REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_ADC0REFSEL_4V34_gc        = (VREF_ADC0REFSEL_4V34_gv << VREF_ADC0REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_ADC0REFSEL_1V5_gc         = (VREF_ADC0REFSEL_1V5_gv << VREF_ADC0REFSEL_gp)   /* Voltage reference at 1.5V */
} VREF_ADC0REFSEL_t;

/* ADC1 reference select bit group values */
typedef enum VREF_ADC1REFSEL_VALUES_enum
{
    VREF_ADC1REFSEL_0V55_gv        = 0x00,  /* Voltage reference at 0.55V */
    VREF_ADC1REFSEL_1V1_gv         = 0x01,  /* Voltage reference at 1.1V */
    VREF_ADC1REFSEL_2V5_gv         = 0x02,  /* Voltage reference at 2.5V */
    VREF_ADC1REFSEL_4V34_gv        = 0x03,  /* Voltage reference at 4.34V */
    VREF_ADC1REFSEL_1V5_gv         = 0x04   /* Voltage reference at 1.5V */
} VREF_ADC1REFSEL_values_t;

/* ADC1 reference select bit group configurations*/
typedef enum VREF_ADC1REFSEL_enum
{
    VREF_ADC1REFSEL_0V55_gc        = (VREF_ADC1REFSEL_0V55_gv << VREF_ADC1REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_ADC1REFSEL_1V1_gc         = (VREF_ADC1REFSEL_1V1_gv << VREF_ADC1REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_ADC1REFSEL_2V5_gc         = (VREF_ADC1REFSEL_2V5_gv << VREF_ADC1REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_ADC1REFSEL_4V34_gc        = (VREF_ADC1REFSEL_4V34_gv << VREF_ADC1REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_ADC1REFSEL_1V5_gc         = (VREF_ADC1REFSEL_1V5_gv << VREF_ADC1REFSEL_gp)   /* Voltage reference at 1.5V */
} VREF_ADC1REFSEL_t;

/* DAC0/AC0 reference select bit group values */
typedef enum VREF_DAC0REFSEL_VALUES_enum
{
    VREF_DAC0REFSEL_0V55_gv        = 0x00,  /* Voltage reference at 0.55V */
    VREF_DAC0REFSEL_1V1_gv         = 0x01,  /* Voltage reference at 1.1V */
    VREF_DAC0REFSEL_2V5_gv         = 0x02,  /* Voltage reference at 2.5V */
    VREF_DAC0REFSEL_4V34_gv        = 0x03,  /* Voltage reference at 4.34V */
    VREF_DAC0REFSEL_1V5_gv         = 0x04   /* Voltage reference at 1.5V */
} VREF_DAC0REFSEL_values_t;

/* DAC0/AC0 reference select bit group configurations*/
typedef enum VREF_DAC0REFSEL_enum
{
    VREF_DAC0REFSEL_0V55_gc        = (VREF_DAC0REFSEL_0V55_gv << VREF_DAC0REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_DAC0REFSEL_1V1_gc         = (VREF_DAC0REFSEL_1V1_gv << VREF_DAC0REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_DAC0REFSEL_2V5_gc         = (VREF_DAC0REFSEL_2V5_gv << VREF_DAC0REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_DAC0REFSEL_4V34_gc        = (VREF_DAC0REFSEL_4V34_gv << VREF_DAC0REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_DAC0REFSEL_1V5_gc         = (VREF_DAC0REFSEL_1V5_gv << VREF_DAC0REFSEL_gp)   /* Voltage reference at 1.5V */
} VREF_DAC0REFSEL_t;

/* DAC1/AC1 reference select bit group values */
typedef enum VREF_DAC1REFSEL_VALUES_enum
{
    VREF_DAC1REFSEL_0V55_gv        = 0x00,  /* Voltage reference at 0.55V */
    VREF_DAC1REFSEL_1V1_gv         = 0x01,  /* Voltage reference at 1.1V */
    VREF_DAC1REFSEL_2V5_gv         = 0x02,  /* Voltage reference at 2.5V */
    VREF_DAC1REFSEL_4V34_gv        = 0x03,  /* Voltage reference at 4.34V */
    VREF_DAC1REFSEL_1V5_gv         = 0x04   /* Voltage reference at 1.5V */
} VREF_DAC1REFSEL_values_t;

/* DAC1/AC1 reference select bit group configurations*/
typedef enum VREF_DAC1REFSEL_enum
{
    VREF_DAC1REFSEL_0V55_gc        = (VREF_DAC1REFSEL_0V55_gv << VREF_DAC1REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_DAC1REFSEL_1V1_gc         = (VREF_DAC1REFSEL_1V1_gv << VREF_DAC1REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_DAC1REFSEL_2V5_gc         = (VREF_DAC1REFSEL_2V5_gv << VREF_DAC1REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_DAC1REFSEL_4V34_gc        = (VREF_DAC1REFSEL_4V34_gv << VREF_DAC1REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_DAC1REFSEL_1V5_gc         = (VREF_DAC1REFSEL_1V5_gv << VREF_DAC1REFSEL_gp)   /* Voltage reference at 1.5V */
} VREF_DAC1REFSEL_t;

/* DAC2/AC2 reference select bit group values */
typedef enum VREF_DAC2REFSEL_VALUES_enum
{
    VREF_DAC2REFSEL_0V55_gv        = 0x00,  /* Voltage reference at 0.55V */
    VREF_DAC2REFSEL_1V1_gv         = 0x01,  /* Voltage reference at 1.1V */
    VREF_DAC2REFSEL_2V5_gv         = 0x02,  /* Voltage reference at 2.5V */
    VREF_DAC2REFSEL_4V34_gv        = 0x03,  /* Voltage reference at 4.34V */
    VREF_DAC2REFSEL_1V5_gv         = 0x04   /* Voltage reference at 1.5V */
} VREF_DAC2REFSEL_values_t;

/* DAC2/AC2 reference select bit group configurations*/
typedef enum VREF_DAC2REFSEL_enum
{
    VREF_DAC2REFSEL_0V55_gc        = (VREF_DAC2REFSEL_0V55_gv << VREF_DAC2REFSEL_gp),  /* Voltage reference at 0.55V */
    VREF_DAC2REFSEL_1V1_gc         = (VREF_DAC2REFSEL_1V1_gv << VREF_DAC2REFSEL_gp),  /* Voltage reference at 1.1V */
    VREF_DAC2REFSEL_2V5_gc         = (VREF_DAC2REFSEL_2V5_gv << VREF_DAC2REFSEL_gp),  /* Voltage reference at 2.5V */
    VREF_DAC2REFSEL_4V34_gc        = (VREF_DAC2REFSEL_4V34_gv << VREF_DAC2REFSEL_gp),  /* Voltage reference at 4.34V */
    VREF_DAC2REFSEL_1V5_gc         = (VREF_DAC2REFSEL_1V5_gv << VREF_DAC2REFSEL_gp)   /* Voltage reference at 1.5V */
} VREF_DAC2REFSEL_t;
