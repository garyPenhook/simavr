/*
	...
	OpenGL host "board" for the modern-AVR (atmega4809) LED demo. It opens a
	...
	This is the visual counterpart to the headless board_atmega4809 / the
	board_modern_avr coverage runner: same modern engine, but with a GUI.
...
static const char * fname = "atmega4809_ledramp.axf";
...
main(int argc, char *argv[])
{
	...
	window = glutCreateWindow("simavr - atmega4809 PORTA LEDs");
